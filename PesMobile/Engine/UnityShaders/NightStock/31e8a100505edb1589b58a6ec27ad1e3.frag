...
INTERFACE_LOCATION(2) in highp vec4 in_TEXCOORD4;
...
void main()
{
	...
	float h12;
	h12 = ((min(2.500000e-01,exp2((-9.280000e+00*max(dot(v7,v5),0.000000e+00))))*5.000000e-01)+2.875000e-02);
	highp vec2 v13;
	v13.xy = (in_TEXCOORD4.xy*vec2(1.000000e+00,5.000000e-01));
	vec3 v14;
	v14.xyz = ((texture(ps1,v13).xyz*PrecomputedLightingBuffer_LightMapScale[0].xyz)+PrecomputedLightingBuffer_LightMapAdd[0].xyz);
	float h15;
	h15 = dot(v14,vec3(3.000000e-01,5.900000e-01,1.100000e-01));
	highp vec4 v16;
	v16.w = 1.000000e+00;
	highp vec3 v17;
	v17.xyz = v7.yzx;
	...
	float h18;
	highp vec4 v19;
	v19.xyzw = ((texture(ps1,(v13+vec2(0.000000e+00,5.000000e-01)))*PrecomputedLightingBuffer_LightMapScale[1])+PrecomputedLightingBuffer_LightMapAdd[1]);
	float h20;
	h20 = max(0.000000e+00,dot(v19,v16));
	h18 = ((exp2(((h15*1.600000e+01)+-8.000000e+00))+-3.906250e-03)*h20);
	vec3 v21;
	v21.xyz = (v14*vec3((h18/h15)));
	vec4 v22;
	v22.xyz = v21;
	v22.w = h18;
	highp vec3 v23;
	...
	v24.xyz = v5;
	highp vec3 v25;
	v25.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	v23.xyz = normalize((v24+v25));
	highp vec3 v26;
	vec3 v27;
	v27.xyz = v23;
	highp vec3 v28;
	v28.xyz = cross(v7,v27);
	v26.xyz = v28;
	highp float f29;
	highp vec3 v30;
	v30.xyz = v7;
	float h31;
	h31 = max(0.000000e+00,dot(v30,v23));
	highp float f32;
	f32 = (h31*2.500000e-01);
	f29 = f32;
	highp float f33;
	highp float f34;
	f34 = 2.500000e-01;
	f33 = (f34/(dot(v26,v26)+(f29*f29)));
	vec3 v35;
	highp vec3 v36;
	v36.xyz = (v21*vec3(3.000000e-01,3.000000e-01,3.000000e-01));
	highp vec3 v37;
	v37.xyz = v7;
	highp vec3 v38;
	...
	f39 = 0.000000e+00;
	highp vec3 v40;
	v40.xyz = MobileDirectionalLight_DirectionalLightColor.xyz;
	float h41;
	h41 = min((f33*f33),6.550400e+04);
	highp vec3 v42;
	v42.xyz = (vec3(3.000000e-01,3.000000e-01,3.000000e-01)+vec3((h12*(3.750000e-01*h41))));
	vec3 v43;
	v43.xyz = (v36*View_IndirectLightingColorScale);
	vec3 v44;
	v44.xyz = ((vec3((f39*max(0.000000e+00,dot(v37,v38))))*v40)*v42);
	v35.xyz = (v43+v44);
	vec3 v45;
	float h46;
	h46 = float((pu_h[0].w>0.000000e+00));
	highp float f47;
	highp float f48;
	f48 = pu_h[0].w;
	highp float f49;
	highp float f50;
	f50 = View_ReflectionCubemapMaxMip;
	f49 = f50;
	f47 = (bool(h46))?(f48):(f49);
	vec4 v51;
	float h52;
	h52 = f47;
	highp float f53;
	f53 = (-3.200000e+00+h52);
	v51.xyzw = textureLod(ps0,v11,f53);
	if (bool(h46))
	{
		vec3 v54;
		v54.xyz = View_SkyLightColor.xyz;
		v45.xyz = (v51.xyz*v54);
	}
	else
	{
		vec3 v55;
		v55.xyz = (v51.xyz*vec3((v51.w*1.600000e+01)));
		float h56;
		h56 = pu_h[0].x;
		v45.xyz = ((v55*v55)*vec3(h56));
	}
	highp vec3 v57;
	highp vec4 v58;
	v58.w = 1.000000e+00;
	...
	v59.xyz = v7;
	v58.xyz = v59;
	v57.x = dot(View_SkyIrradianceEnvironmentMap[0],v58);
	v57.y = dot(View_SkyIrradianceEnvironmentMap[1],v58);
	v57.z = dot(View_SkyIrradianceEnvironmentMap[2],v58);
	highp vec3 v60;
	v60.xyz = vec3(3.000000e-01,3.000000e-01,3.000000e-01);
	highp float f61;
	f61 = 1.000000e+00;
	vec3 v62;
	v62.xyz = (((max(vec3(0.000000e+00,0.000000e+00,0.000000e+00),v57)*View_SkyLightColor.xyz)*v60)*vec3(f61));
	v0.xyz = ((((v35+((v45*v22.www)*vec3(h12)))+v62)*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v0.w = 0.000000e+00;
	float h63;
	h63 = min(in_TEXCOORD8.w,6.550000e+04);
	v0.w = h63;
	out_Target0.xyzw = v0;
}
