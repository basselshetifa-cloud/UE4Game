...
void main()
{
	...
	highp vec3 v10;
	v10.xyz = ((v4.xyz*v9.zzz)+(((cross(v4.xyz,v2)*v4.www)*v9.yyy)+(v2*v9.xxx)));
	vec3 v11;
	v11.xyz = normalize(v10);
	v8.xyz = v11;
	vec3 v12;
	v12.xyz = ((-v6)+((v8*vec3(dot(v8,v6)))*vec3(2.000000e+00,2.000000e+00,2.000000e+00)));
	vec3 v13;
	v13.xyz = clamp(texture(ps1,in_TEXCOORD0.xy).xyz,vec3(0.000000e+00,0.000000e+00,0.000000e+00),vec3(1.000000e+00,1.000000e+00,1.000000e+00));
	float h14;
	h14 = ((min(4.900000e-01,exp2((-9.280000e+00*max(dot(v8,v6),0.000000e+00))))*7.000000e-01)+3.425000e-02);
	vec4 v15;
	vec4 v16;
	float h17;
	vec4 v18;
	vec4 v19;
	v18.x = 2.820950e-01;
	v18.y = (-4.886030e-01*v8.y);
	v18.z = (4.886030e-01*v8.z);
	v18.w = (-4.886030e-01*v8.x);
	vec3 v20;
	v20.xyz = (v8*v8);
	v19.x = ((1.092548e+00*v8.x)*v8.y);
	v19.y = ((-1.092548e+00*v8.y)*v8.z);
	v19.z = (3.153920e-01*((3.000000e+00*v20.z)+-1.000000e+00));
	v19.w = ((-1.092548e+00*v8.x)*v8.z);
	v15.xyzw = v18;
	v15.x = 8.862275e-01;
	v15.yzw = (v18.yzw*vec3(2.094395e+00,2.094395e+00,2.094395e+00));
	v16.xyzw = (v19*vec4(7.853982e-01,7.853982e-01,7.853982e-01,7.853982e-01));
	h17 = (4.290426e-01*(v20.x+(-v20.y)));
	vec3 v21;
	v21.xyz = vec3(0.000000e+00,0.000000e+00,0.000000e+00);
	vec4 v22;
	v22.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients0[0];
	vec4 v23;
	v23.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients1[0];
	float h24;
	h24 = IndirectLightingCache_IndirectLightingSHCoefficients2.x;
	v21.x = ((dot(v22,v15)+dot(v23,v16))+(h24*h17));
	vec4 v25;
	v25.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients0[1];
	vec4 v26;
	v26.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients1[1];
	float h27;
	h27 = IndirectLightingCache_IndirectLightingSHCoefficients2.y;
	v21.y = ((dot(v25,v15)+dot(v26,v16))+(h27*h17));
	vec4 v28;
	v28.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients0[2];
	vec4 v29;
	v29.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients1[2];
	float h30;
	h30 = IndirectLightingCache_IndirectLightingSHCoefficients2.z;
	v21.z = ((dot(v28,v15)+dot(v29,v16))+(h30*h17));
	vec3 v31;
	v31.xyz = max(vec3(0.000000e+00,0.000000e+00,0.000000e+00),v21);
	float h32;
	h32 = dot(v31,vec3(3.000000e-01,5.900000e-01,1.100000e-01));
	highp vec3 v33;
	v33.xyz = (v13*v31);
	vec3 v34;
	v34.xyz = (v33*View_IndirectLightingColorScale);
	v1.xyz = v34;
	float h35;
	h35 = (((Primitive_UseSingleSampleShadowFromStationaryLights>0.000000e+00)&&(View_IndirectLightingCacheShowFlag>0.000000e+00)))?(IndirectLightingCache_DirectionalLightShadowing):(1.000000e+00);
	highp vec3 v36;
	highp vec3 v37;
	v37.xyz = v6;
	highp vec3 v38;
	v38.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	v36.xyz = normalize((v37+v38));
	highp vec3 v39;
	vec3 v40;
	v40.xyz = v36;
	highp vec3 v41;
	v41.xyz = cross(v8,v40);
	v39.xyz = v41;
	highp float f42;
	highp vec3 v43;
	v43.xyz = v8;
	float h44;
	h44 = max(0.000000e+00,dot(v43,v36));
	highp float f45;
	f45 = (h44*9.000000e-02);
	f42 = f45;
	highp float f46;
	highp float f47;
	f47 = 9.000000e-02;
	f46 = (f47/(dot(v39,v39)+(f42*f42)));
	vec3 v48;
	highp vec3 v49;
	v49.xyz = v8;
	highp vec3 v50;
	v50.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	highp float f51;
	f51 = h35;
	highp vec3 v52;
	v52.xyz = MobileDirectionalLight_DirectionalLightColor.xyz;
	float h53;
	h53 = min((f46*f46),6.550400e+04);
	highp vec3 v54;
	v54.xyz = (v13+vec3((h14*(3.250000e-01*h53))));
	vec3 v55;
	v55.xyz = ((vec3((f51*max(0.000000e+00,dot(v49,v50))))*v52)*v54);
	v48.xyz = (v1+v55);
	vec3 v56;
	float h57;
	h57 = float((pu_h[0].w>0.000000e+00));
	highp float f58;
	highp float f59;
	f59 = pu_h[0].w;
	highp float f60;
	highp float f61;
	f61 = View_ReflectionCubemapMaxMip;
	f60 = f61;
	f58 = (bool(h57))?(f59):(f60);
	vec4 v62;
	float h63;
	h63 = f58;
	highp float f64;
	f64 = (-4.084359e+00+h63);
	v62.xyzw = textureLod(ps0,v12,f64);
	if (bool(h57))
	{
		vec3 v65;
		v65.xyz = View_SkyLightColor.xyz;
		v56.xyz = (v62.xyz*v65);
	}
	else
	{
		vec3 v66;
		v66.xyz = (v62.xyz*vec3((v62.w*1.600000e+01)));
		float h67;
		h67 = pu_h[0].x;
		v56.xyz = ((v66*v66)*vec3(h67));
	}
	highp vec3 v68;
	highp vec4 v69;
	v69.w = 1.000000e+00;
	...
	v70.xyz = v8;
	v69.xyz = v70;
	v68.x = dot(View_SkyIrradianceEnvironmentMap[0],v69);
	v68.y = dot(View_SkyIrradianceEnvironmentMap[1],v69);
	v68.z = dot(View_SkyIrradianceEnvironmentMap[2],v69);
	highp vec3 v71;
	v71.xyz = v13;
	highp float f72;
	f72 = 1.000000e+00;
	vec3 v73;
	v73.xyz = (((max(vec3(0.000000e+00,0.000000e+00,0.000000e+00),v68)*View_SkyLightColor.xyz)*v71)*vec3(f72));
	v0.xyz = ((((v48+((v56*vec3(h32))*vec3(h14)))+v73)*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v0.w = 0.000000e+00;
	float h74;
	h74 = min(in_TEXCOORD8.w,6.550000e+04);
	v0.w = h74;
	out_Target0.xyzw = v0;
}
