...
void main()
{
	...
	vec4 v12;
	v12.xyzw = texture(ps1,in_TEXCOORD0.xy);
	if (((v12.w+-3.333000e-01)<0.000000e+00)) discard;
	vec3 v13;
	v13.xyz = clamp(v12.xyz,vec3(0.000000e+00,0.000000e+00,0.000000e+00),vec3(1.000000e+00,1.000000e+00,1.000000e+00));
	float h14;
	h14 = ((min(2.500000e-01,exp2((-9.280000e+00*max(dot(v7,v5),0.000000e+00))))*5.000000e-01)+2.875000e-02);
	highp vec2 v15;
	v15.xy = (in_TEXCOORD4.xy*vec2(1.000000e+00,5.000000e-01));
	vec3 v16;
	v16.xyz = ((texture(ps2,v15).xyz*PrecomputedLightingBuffer_LightMapScale[0].xyz)+PrecomputedLightingBuffer_LightMapAdd[0].xyz);
	float h17;
	h17 = dot(v16,vec3(3.000000e-01,5.900000e-01,1.100000e-01));
	highp vec4 v18;
	v18.w = 1.000000e+00;
	highp vec3 v19;
	v19.xyz = v7.yzx;
	...
	float h20;
	highp vec4 v21;
	v21.xyzw = ((texture(ps2,(v15+vec2(0.000000e+00,5.000000e-01)))*PrecomputedLightingBuffer_LightMapScale[1])+PrecomputedLightingBuffer_LightMapAdd[1]);
	float h22;
	h22 = max(0.000000e+00,dot(v21,v18));
	h20 = ((exp2(((h17*1.600000e+01)+-8.000000e+00))+-3.906250e-03)*h22);
	vec3 v23;
	v23.xyz = (v16*vec3((h20/h17)));
	vec4 v24;
	v24.xyz = v23;
	v24.w = h20;
	highp vec3 v25;
	...
	v26.xyz = v5;
	highp vec3 v27;
	v27.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	v25.xyz = normalize((v26+v27));
	highp vec3 v28;
	vec3 v29;
	v29.xyz = v25;
	highp vec3 v30;
	v30.xyz = cross(v7,v29);
	v28.xyz = v30;
	highp float f31;
	highp vec3 v32;
	v32.xyz = v7;
	float h33;
	h33 = max(0.000000e+00,dot(v32,v25));
	highp float f34;
	f34 = (h33*2.500000e-01);
	f31 = f34;
	highp float f35;
	highp float f36;
	f36 = 2.500000e-01;
	f35 = (f36/(dot(v28,v28)+(f31*f31)));
	vec3 v37;
	highp vec3 v38;
	v38.xyz = (v23*v13);
	highp vec3 v39;
	v39.xyz = v7;
	highp vec3 v40;
	v40.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	highp float f41;
	f41 = 0.000000e+00;
	highp vec3 v42;
	v42.xyz = MobileDirectionalLight_DirectionalLightColor.xyz;
	float h43;
	h43 = min((f35*f35),6.550400e+04);
	highp vec3 v44;
	v44.xyz = (v13+vec3((h14*(3.750000e-01*h43))));
	vec3 v45;
	v45.xyz = (v38*View_IndirectLightingColorScale);
	vec3 v46;
	v46.xyz = ((vec3((f41*max(0.000000e+00,dot(v39,v40))))*v42)*v44);
	v37.xyz = (v45+v46);
	vec3 v47;
	float h48;
	h48 = float((pu_h[0].w>0.000000e+00));
	highp float f49;
	highp float f50;
	f50 = pu_h[0].w;
	highp float f51;
	highp float f52;
	f52 = View_ReflectionCubemapMaxMip;
	f51 = f52;
	f49 = (bool(h48))?(f50):(f51);
	vec4 v53;
	float h54;
	h54 = f49;
	highp float f55;
	f55 = (-3.200000e+00+h54);
	v53.xyzw = textureLod(ps0,v11,f55);
	if (bool(h48))
	{
		vec3 v56;
		v56.xyz = View_SkyLightColor.xyz;
		v47.xyz = (v53.xyz*v56);
	}
	else
	{
		vec3 v57;
		v57.xyz = (v53.xyz*vec3((v53.w*1.600000e+01)));
		float h58;
		h58 = pu_h[0].x;
		v47.xyz = ((v57*v57)*vec3(h58));
	}
	highp vec3 v59;
	highp vec4 v60;
	v60.w = 1.000000e+00;
	...
	v61.xyz = v7;
	v60.xyz = v61;
	v59.x = dot(View_SkyIrradianceEnvironmentMap[0],v60);
	v59.y = dot(View_SkyIrradianceEnvironmentMap[1],v60);
	v59.z = dot(View_SkyIrradianceEnvironmentMap[2],v60);
	highp vec3 v62;
	v62.xyz = v13;
	highp float f63;
	f63 = 1.000000e+00;
	vec3 v64;
	v64.xyz = (((max(vec3(0.000000e+00,0.000000e+00,0.000000e+00),v59)*View_SkyLightColor.xyz)*v62)*vec3(f63));
	v0.xyz = ((((v37+((v47*v24.www)*vec3(h14)))+v64)*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v0.w = 0.000000e+00;
	float h65;
	h65 = min(in_TEXCOORD8.w,6.550000e+04);
	v0.w = h65;
	out_Target0.xyzw = v0;
}
