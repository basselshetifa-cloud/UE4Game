...
void main()
{
	...
	vec2 v18;
	vec2 v19;
	v19.xy = ((vec2(-1.040000e+00,1.040000e+00)*vec2(((min(1.600000e-01,exp2((-9.280000e+00*max(dot(v8,v6),0.000000e+00))))*4.000000e-01)+2.600000e-02)))+vec2(6.967999e-01,-2.680000e-02));
	v18.xy = v19;
	...
	highp vec3 v59;
	v59.xyz = (v15+(v17*vec3((4.000000e-01*h58))));
	vec3 v60;
