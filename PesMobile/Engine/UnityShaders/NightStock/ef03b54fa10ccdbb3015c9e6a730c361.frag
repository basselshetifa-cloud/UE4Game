...
void main()
{
	vec4 v0;
	vec4 v1;
	v1.xyzw = texture(ps0,in_TEXCOORD0.xy);
	v0.xyzw = v1;
	v0.w = 0.000000e+00;
	float h2;
	float h3;
	...
	f4 = v1.w;
	float h5;
	h5 = clamp(((View_DepthOfFieldFocalDistance+(-f4))/View_DepthOfFieldNearTransitionRegion),0.000000e+00,1.000000e+00);
	h3 = h5;
	float h6;
	highp float f7;
	f7 = v1.w;
	float h8;
	h8 = clamp(((f7+(-(View_DepthOfFieldFocalDistance+View_DepthOfFieldFocalRegion)))/View_DepthOfFieldFarTransitionRegion),0.000000e+00,1.000000e+00);
	h6 = h8;
	if ((h6>h3))
	{
		h2 = ((h6*5.000000e-01)+5.000000e-01);
	}
	else
	{
		h2 = ((1.000000e+00+(-h3))*5.000000e-01);
	}
	v0.w = h2;
	out_Target0.xyzw = v0;
}
