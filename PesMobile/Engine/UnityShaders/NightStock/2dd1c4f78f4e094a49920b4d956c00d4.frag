...
void main()
{
	...
	vec2 v6;
	vec2 v7;
	v7.xy = in_TEXCOORD0.xy;
	float h8;
	h8 = ((View_GameTime+(-(2.000000e+00*trunc((View_GameTime/2.000000e+00)))))*5.000000e-01);
	v6.xy = ((v7*vec2(1.000000e+00,6.250000e-02))+(vec2(0.000000e+00,1.000000e+00)*vec2((floor((fract(h8)*1.600000e+01))*6.250000e-02))));
	vec2 v9;
	highp vec2 v10;
	v10.xy = v6;
	v9.xy = ((texture(ps1,v10).xy*vec2(2.000000e+00,2.000000e+00))+vec2(-1.000000e+00,-1.000000e+00));
	vec4 v11;
	v11.w = 1.000000e+00;
	v11.xy = v9;
	v11.z = sqrt(clamp((1.000000e+00+(-dot(v9,v9))),0.000000e+00,1.000000e+00));
	vec3 v12;
	v12.xyz = v11.xyz;
	highp vec3 v13;
	v13.xyz = ((v3.xyz*v12.zzz)+(((cross(v3.xyz,v1)*v3.www)*v12.yyy)+(v1*v12.xxx)));
	vec3 v14;
	...
	highp vec2 v16;
	v16.xy = v6;
	v15.xyzw = texture(ps0,v16);
	if (((v15.w+-3.333000e-01)<0.000000e+00)) discard;
	vec3 v17;
	v17.xyz = (clamp(v15.xyz,vec3(0.000000e+00,0.000000e+00,0.000000e+00),vec3(1.000000e+00,1.000000e+00,1.000000e+00))+vec3(1.800000e-02,1.800000e-02,1.800000e-02));
	highp vec2 v18;
	v18.xy = (in_TEXCOORD4.xy*vec2(1.000000e+00,5.000000e-01));
	vec3 v19;
	v19.xyz = ((texture(ps2,v18).xyz*PrecomputedLightingBuffer_LightMapScale[0].xyz)+PrecomputedLightingBuffer_LightMapAdd[0].xyz);
	float h20;
	h20 = dot(v19,vec3(3.000000e-01,5.900000e-01,1.100000e-01));
	highp vec4 v21;
	v21.w = 1.000000e+00;
	highp vec3 v22;
	v22.xyz = v5.yzx;
	...
	v25.xyz = v5;
	v24.xyz = v25;
	v23.x = dot(View_SkyIrradianceEnvironmentMap[0],v24);
	v23.y = dot(View_SkyIrradianceEnvironmentMap[1],v24);
	v23.z = dot(View_SkyIrradianceEnvironmentMap[2],v24);
	highp vec4 v26;
	v26.xyzw = ((texture(ps2,(v18+vec2(0.000000e+00,5.000000e-01)))*PrecomputedLightingBuffer_LightMapScale[1])+PrecomputedLightingBuffer_LightMapAdd[1]);
	float h27;
	h27 = max(0.000000e+00,dot(v26,v21));
	highp vec3 v28;
	v28.xyz = ((v19*vec3((((exp2(((h20*1.600000e+01)+-8.000000e+00))+-3.906250e-03)*h27)/h20)))*v17);
	highp vec3 v29;
	v29.xyz = v5;
	highp vec3 v30;
	v30.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	highp float f31;
	f31 = 0.000000e+00;
	highp vec3 v32;
	v32.xyz = MobileDirectionalLight_DirectionalLightColor.xyz;
	highp vec3 v33;
	v33.xyz = v17;
	vec3 v34;
	v34.xyz = (v28*View_IndirectLightingColorScale);
	vec3 v35;
	v35.xyz = ((vec3((f31*max(0.000000e+00,dot(v29,v30))))*v32)*v33);
	highp vec3 v36;
	v36.xyz = v17;
	highp float f37;
	f37 = 1.000000e+00;
	vec3 v38;
	v38.xyz = (((max(vec3(0.000000e+00,0.000000e+00,0.000000e+00),v23)*View_SkyLightColor.xyz)*v36)*vec3(f37));
	v0.xyz = ((((v34+v35)+v38)*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v0.w = 0.000000e+00;
	float h39;
	h39 = min(in_TEXCOORD8.w,6.550000e+04);
	v0.w = h39;
	out_Target0.xyzw = v0;
}
