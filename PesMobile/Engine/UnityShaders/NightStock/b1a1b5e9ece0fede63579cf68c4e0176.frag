...
void main()
{
	...
	v11.xyzw = texture(ps2,v13);
	float h14;
	h14 = min(max((v11.w*pow(max((1.000000e+00+(-v5.z)),0.000000e+00),4.618721e+00)),0.000000e+00),1.500000e-01);
	vec2 v15;
	v15.x = v5.x;
	v15.y = v5.y;
	vec3 v16;
	...
	h23 = abs(v5.y);
	vec4 v24;
	v24.xyzw = texture(ps1,in_TEXCOORD0.xy);
	float h25;
	...
	v39.z = h33;
	float h40;
	h40 = ((dot(v21,(v39/vec3(sqrt(dot(v35,v37)))))*5.000000e-01)+5.000000e-01);
	vec3 v41;
	vec3 v42;
	v42.xyz = View_ViewToTranslatedWorld[2].xyz;
	v41.xyz = (mix(vec3(0.000000e+00,0.000000e+00,0.000000e+00),vec3(6.903540e-01,1.000000e+00,0.000000e+00),vec3(((h14*pow(max((h40*pow(max(v24.w,0.000000e+00),4.000000e-01)),0.000000e+00),5.000000e-01))*((dot(vec3(0.000000e+00,0.000000e+00,-1.000000e+00),v42)*6.500000e-01)+3.500000e-01))))*vec3(1.798484e+00,1.798484e+00,1.798484e+00));
	vec3 v43;
	v43.xyz = ((texture(ps0,in_TEXCOORD0.xy).xyz*Material_ScalarExpressions[0].yyy)+(Material_ScalarExpressions[0].zzz*v11.xyz));
	float h44;
	h44 = dot(v43,vec3(3.000000e-01,5.900000e-01,1.100000e-01));
	vec3 v45;
	v45.x = h44;
	v45.y = h44;
	v45.z = h44;
	vec3 v46;
	v46.xyz = mix(v43,v45,vec3(1.666440e-01,1.666440e-01,1.666440e-01));
	float h47;
	h47 = (v46.x*8.980880e-01);
	vec2 v48;
	v48.x = h47;
	v48.y = v46.y;
	vec3 v49;
	...
	vec3 v50;
	highp vec3 v51;
	v51.xyz = vec3(6.306130e-01,6.320000e-01,5.593200e-01);
	highp vec3 v52;
	v52.xyz = vec3(3.339480e-01,4.080000e-01,2.060400e-01);
	highp float f53;
	f53 = h40;
	vec3 v54;
	v54.xyz = mix((v51*vec3(1.111111e+00,1.111111e+00,1.111111e+00)),(v52*vec3(9.000000e-01,9.000000e-01,9.000000e-01)),vec3(f53));
	v50.xyz = v54;
	vec3 v55;
	v55.xyz = (vec3(1.000000e+00,1.000000e+00,1.000000e+00)+(-(((vec3(1.000000e+00,1.000000e+00,1.000000e+00)+(-v49))*vec3(2.000000e+00,2.000000e+00,2.000000e+00))*(vec3(1.000000e+00,1.000000e+00,1.000000e+00)+(-v50)))));
	vec2 v56;
	v56.x = h47;
	v56.y = v46.y;
	vec3 v57;
	...
	v57.z = v46.z;
	vec3 v58;
	v58.xyz = ((v57*vec3(2.000000e+00,2.000000e+00,2.000000e+00))*v50);
	float h59;
	float h60;
	h60 = v55.x;
	float h61;
	h61 = v58.x;
	h59 = ((h47>=5.000000e-01))?(h60):(h61);
	vec2 v62;
	v62.x = h47;
	v62.y = v46.y;
	float h63;
	...
	float h65;
	h65 = v58.y;
	h63 = ((v62.y>=5.000000e-01))?(h64):(h65);
	vec2 v66;
	v66.x = h47;
	v66.y = v46.y;
	vec3 v67;
	...
	float h70;
	h70 = v58.z;
	h68 = ((v67.z>=5.000000e-01))?(h69):(h70);
	vec2 v71;
	v71.x = h59;
	v71.y = h63;
	vec3 v72;
	...
	v72.z = h68;
	vec3 v73;
	v73.xyz = clamp(v72,vec3(0.000000e+00,0.000000e+00,0.000000e+00),vec3(1.000000e+00,1.000000e+00,1.000000e+00));
	highp vec2 v74;
	v74.xy = (in_TEXCOORD4.xy*vec2(1.000000e+00,5.000000e-01));
	vec3 v75;
	v75.xyz = ((texture(ps3,v74).xyz*PrecomputedLightingBuffer_LightMapScale[0].xyz)+PrecomputedLightingBuffer_LightMapAdd[0].xyz);
	float h76;
	h76 = dot(v75,vec3(3.000000e-01,5.900000e-01,1.100000e-01));
	highp vec4 v77;
	v77.w = 1.000000e+00;
	highp vec3 v78;
	v78.xyz = v7.yzx;
	...
	v81.xyz = v7;
	v80.xyz = v81;
	v79.x = dot(View_SkyIrradianceEnvironmentMap[0],v80);
	v79.y = dot(View_SkyIrradianceEnvironmentMap[1],v80);
	v79.z = dot(View_SkyIrradianceEnvironmentMap[2],v80);
	highp vec4 v82;
	v82.xyzw = ((texture(ps3,(v74+vec2(0.000000e+00,5.000000e-01)))*PrecomputedLightingBuffer_LightMapScale[1])+PrecomputedLightingBuffer_LightMapAdd[1]);
	float h83;
	h83 = max(0.000000e+00,dot(v82,v77));
	highp vec3 v84;
	v84.xyz = ((v75*vec3((((exp2(((h76*1.600000e+01)+-8.000000e+00))+-3.906250e-03)*h83)/h76)))*v73);
	highp vec3 v85;
	v85.xyz = v7;
	highp vec3 v86;
	v86.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	highp float f87;
	f87 = 0.000000e+00;
	highp vec3 v88;
	v88.xyz = MobileDirectionalLight_DirectionalLightColor.xyz;
	highp vec3 v89;
	v89.xyz = v73;
	vec3 v90;
	v90.xyz = (v84*View_IndirectLightingColorScale);
	vec3 v91;
	v91.xyz = ((vec3((f87*max(0.000000e+00,dot(v85,v86))))*v88)*v89);
	highp vec3 v92;
	v92.xyz = v73;
	highp float f93;
	f93 = 1.000000e+00;
	vec3 v94;
	v94.xyz = (((max(vec3(0.000000e+00,0.000000e+00,0.000000e+00),v79)*View_SkyLightColor.xyz)*v92)*vec3(f93));
	v0.xyz = (((((v90+v91)+v94)+max(v41,vec3(0.000000e+00,0.000000e+00,0.000000e+00)))*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v0.w = 0.000000e+00;
	float h95;
	h95 = min(in_TEXCOORD8.w,6.550000e+04);
	v0.w = h95;
	out_Target0.xyzw = v0;
}
