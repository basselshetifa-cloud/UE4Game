...
void main()
{
	...
	vec3 v12;
	v12.xyz = clamp(texture(ps1,in_TEXCOORD0.xy).xxx,vec3(0.000000e+00,0.000000e+00,0.000000e+00),vec3(1.000000e+00,1.000000e+00,1.000000e+00));
	float h13;
	h13 = ((min(2.500000e-01,exp2((-9.280000e+00*max(dot(v7,v5),0.000000e+00))))*5.000000e-01)+2.875000e-02);
	highp vec2 v14;
	v14.xy = (in_TEXCOORD4.xy*vec2(1.000000e+00,5.000000e-01));
	vec3 v15;
	v15.xyz = ((texture(ps2,v14).xyz*PrecomputedLightingBuffer_LightMapScale[0].xyz)+PrecomputedLightingBuffer_LightMapAdd[0].xyz);
	float h16;
	h16 = dot(v15,vec3(3.000000e-01,5.900000e-01,1.100000e-01));
	highp vec4 v17;
	v17.w = 1.000000e+00;
	highp vec3 v18;
	v18.xyz = v7.yzx;
	...
	float h19;
	highp vec4 v20;
	v20.xyzw = ((texture(ps2,(v14+vec2(0.000000e+00,5.000000e-01)))*PrecomputedLightingBuffer_LightMapScale[1])+PrecomputedLightingBuffer_LightMapAdd[1]);
	float h21;
	h21 = max(0.000000e+00,dot(v20,v17));
	h19 = ((exp2(((h16*1.600000e+01)+-8.000000e+00))+-3.906250e-03)*h21);
	vec3 v22;
	v22.xyz = (v15*vec3((h19/h16)));
	vec4 v23;
	v23.xyz = v22;
	v23.w = h19;
	highp vec3 v24;
	...
	v25.xyz = v5;
	highp vec3 v26;
	v26.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	v24.xyz = normalize((v25+v26));
	highp vec3 v27;
	vec3 v28;
	v28.xyz = v24;
	highp vec3 v29;
	v29.xyz = cross(v7,v28);
	v27.xyz = v29;
	highp float f30;
	highp vec3 v31;
	v31.xyz = v7;
	float h32;
	h32 = max(0.000000e+00,dot(v31,v24));
	highp float f33;
	f33 = (h32*2.500000e-01);
	f30 = f33;
	highp float f34;
	highp float f35;
	f35 = 2.500000e-01;
	f34 = (f35/(dot(v27,v27)+(f30*f30)));
	vec3 v36;
	highp vec3 v37;
	v37.xyz = (v22*v12);
	highp vec3 v38;
	...
	f40 = 0.000000e+00;
	highp vec3 v41;
	v41.xyz = MobileDirectionalLight_DirectionalLightColor.xyz;
	float h42;
	h42 = min((f34*f34),6.550400e+04);
	highp vec3 v43;
	v43.xyz = (v12+vec3((h13*(3.750000e-01*h42))));
	vec3 v44;
	v44.xyz = (v37*View_IndirectLightingColorScale);
	vec3 v45;
	v45.xyz = ((vec3((f40*max(0.000000e+00,dot(v38,v39))))*v41)*v43);
	v36.xyz = (v44+v45);
	vec3 v46;
	float h47;
	h47 = float((pu_h[0].w>0.000000e+00));
	highp float f48;
	highp float f49;
	f49 = pu_h[0].w;
	highp float f50;
	highp float f51;
	f51 = View_ReflectionCubemapMaxMip;
	f50 = f51;
	f48 = (bool(h47))?(f49):(f50);
	vec4 v52;
	float h53;
	h53 = f48;
	highp float f54;
	f54 = (-3.200000e+00+h53);
	v52.xyzw = textureLod(ps0,v11,f54);
	if (bool(h47))
	{
		vec3 v55;
		v55.xyz = View_SkyLightColor.xyz;
		v46.xyz = (v52.xyz*v55);
	}
	else
	{
		vec3 v56;
		v56.xyz = (v52.xyz*vec3((v52.w*1.600000e+01)));
		float h57;
		h57 = pu_h[0].x;
		v46.xyz = ((v56*v56)*vec3(h57));
	}
	highp vec3 v58;
	highp vec4 v59;
	v59.w = 1.000000e+00;
	...
	v60.xyz = v7;
	v59.xyz = v60;
	v58.x = dot(View_SkyIrradianceEnvironmentMap[0],v59);
	v58.y = dot(View_SkyIrradianceEnvironmentMap[1],v59);
	v58.z = dot(View_SkyIrradianceEnvironmentMap[2],v59);
	highp vec3 v61;
	v61.xyz = v12;
	highp float f62;
	f62 = 1.000000e+00;
	vec3 v63;
	v63.xyz = (((max(vec3(0.000000e+00,0.000000e+00,0.000000e+00),v58)*View_SkyLightColor.xyz)*v61)*vec3(f62));
	v0.xyz = ((((v36+((v46*v23.www)*vec3(h13)))+v63)*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v0.w = 0.000000e+00;
	float h64;
	h64 = min(in_TEXCOORD8.w,6.550000e+04);
	v0.w = h64;
	out_Target0.xyzw = v0;
}
