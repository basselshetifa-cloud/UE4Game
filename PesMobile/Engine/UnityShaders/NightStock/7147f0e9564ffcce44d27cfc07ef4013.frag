...
void main()
{
	...
	vec3 v3;
	vec3 v4;
	v4.xyz = in_TEXCOORD10.xyz;
	v3.xyz = v4;
	vec4 v5;
	vec4 v6;
	v6.xyzw = in_TEXCOORD11;
	v5.xyzw = v6;
	vec3 v7;
	v7.xyz = (cross(v5.xyz,v3)*v5.www);
	vec3 v8;
	float h9;
	vec3 v10;
	v10.xyz = normalize((-in_TEXCOORD8.xyz));
	v8.xyz = v10;
	highp float f11;
	f11 = Primitive_InvNonUniformScaleAndDeterminantSign.w;
	float h12;
	h12 = (View_CullingSign*f11);
	h9 = h12;
	highp int i13;
	i13 = (b0)?(1):(-1);
	h9 = (h9*float(i13));
	vec3 v14;
	vec3 v15;
	v15.xyz = (vec3(0.000000e+00,0.000000e+00,1.000000e+00)*vec3(h9));
	highp vec3 v16;
	v16.xyz = ((v5.xyz*v15.zzz)+((v7*v15.yyy)+(v3*v15.xxx)));
	vec3 v17;
	v17.xyz = normalize(v16);
	v14.xyz = v17;
	v14.xyz = (v14*vec3(h9));
	vec3 v18;
	v18.xyz = ((-v8)+((v14*vec3(dot(v14,v8)))*vec3(2.000000e+00,2.000000e+00,2.000000e+00)));
	vec4 v19;
	v19.xyzw = texture(ps1,in_TEXCOORD0);
	if (((v19.w+-3.333000e-01)<0.000000e+00)) discard;
	vec3 v20;
	v20.xyz = clamp(v19.xyz,vec3(0.000000e+00,0.000000e+00,0.000000e+00),vec3(1.000000e+00,1.000000e+00,1.000000e+00));
	vec3 v21;
	vec2 v22;
	vec2 v23;
	v23.xy = ((vec2(-1.040000e+00,1.040000e+00)*vec2(((min(4.000000e-02,exp2((-9.280000e+00*max(dot(v14,v8),0.000000e+00))))*2.000000e-01)+2.050000e-02)))+vec2(5.824000e-01,-2.240000e-02));
	v22.xy = v23;
	v22.y = (v23.y*1.600000e-01);
	v21.xyz = ((vec3(3.200000e-03,3.200000e-03,3.200000e-03)*v23.xxx)+v22.yyy);
	vec4 v24;
	vec4 v25;
	float h26;
	vec4 v27;
	vec4 v28;
	v27.x = 2.820950e-01;
	v27.y = (-4.886030e-01*v14.y);
	v27.z = (4.886030e-01*v14.z);
	v27.w = (-4.886030e-01*v14.x);
	vec3 v29;
	v29.xyz = (v14*v14);
	v28.x = ((1.092548e+00*v14.x)*v14.y);
	v28.y = ((-1.092548e+00*v14.y)*v14.z);
	v28.z = (3.153920e-01*((3.000000e+00*v29.z)+-1.000000e+00));
	v28.w = ((-1.092548e+00*v14.x)*v14.z);
	v24.xyzw = v27;
	v24.x = 8.862275e-01;
	v24.yzw = (v27.yzw*vec3(2.094395e+00,2.094395e+00,2.094395e+00));
	v25.xyzw = (v28*vec4(7.853982e-01,7.853982e-01,7.853982e-01,7.853982e-01));
	h26 = (4.290426e-01*(v29.x+(-v29.y)));
	vec3 v30;
	v30.xyz = vec3(0.000000e+00,0.000000e+00,0.000000e+00);
	vec4 v31;
	v31.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients0[0];
	vec4 v32;
	v32.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients1[0];
	float h33;
	h33 = IndirectLightingCache_IndirectLightingSHCoefficients2.x;
	v30.x = ((dot(v31,v24)+dot(v32,v25))+(h33*h26));
	vec4 v34;
	v34.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients0[1];
	vec4 v35;
	v35.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients1[1];
	float h36;
	h36 = IndirectLightingCache_IndirectLightingSHCoefficients2.y;
	v30.y = ((dot(v34,v24)+dot(v35,v25))+(h36*h26));
	vec4 v37;
	v37.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients0[2];
	vec4 v38;
	v38.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients1[2];
	float h39;
	h39 = IndirectLightingCache_IndirectLightingSHCoefficients2.z;
	v30.z = ((dot(v37,v24)+dot(v38,v25))+(h39*h26));
	vec3 v40;
	v40.xyz = max(vec3(0.000000e+00,0.000000e+00,0.000000e+00),v30);
	float h41;
	h41 = dot(v40,vec3(3.000000e-01,5.900000e-01,1.100000e-01));
	highp vec3 v42;
	v42.xyz = (v20*v40);
	vec3 v43;
	v43.xyz = (v42*View_IndirectLightingColorScale);
	v2.xyz = v43;
	float h44;
	h44 = (((Primitive_UseSingleSampleShadowFromStationaryLights>0.000000e+00)&&(View_IndirectLightingCacheShowFlag>0.000000e+00)))?(IndirectLightingCache_DirectionalLightShadowing):(1.000000e+00);
	highp vec3 v45;
	highp vec3 v46;
	v46.xyz = v8;
	highp vec3 v47;
	v47.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	v45.xyz = normalize((v46+v47));
	highp vec3 v48;
	vec3 v49;
	v49.xyz = v45;
	highp vec3 v50;
	v50.xyz = cross(v14,v49);
	v48.xyz = v50;
	highp float f51;
	highp vec3 v52;
	v52.xyz = v14;
	float h53;
	h53 = max(0.000000e+00,dot(v52,v45));
	highp float f54;
	f54 = (h53*6.400000e-01);
	f51 = f54;
	highp float f55;
	highp float f56;
	f56 = 6.400000e-01;
	f55 = (f56/(dot(v48,v48)+(f51*f51)));
	vec3 v57;
	highp vec3 v58;
	v58.xyz = v14;
	highp vec3 v59;
	v59.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	highp float f60;
	f60 = h44;
	highp vec3 v61;
	v61.xyz = MobileDirectionalLight_DirectionalLightColor.xyz;
	float h62;
	h62 = min((f55*f55),6.550400e+04);
	highp vec3 v63;
	v63.xyz = (v20+(v21*vec3((4.500000e-01*h62))));
	vec3 v64;
	v64.xyz = ((vec3((f60*max(0.000000e+00,dot(v58,v59))))*v61)*v63);
	v57.xyz = (v2+v64);
	vec3 v65;
	float h66;
	h66 = float((pu_h[0].w>0.000000e+00));
	highp float f67;
	highp float f68;
	f68 = pu_h[0].w;
	highp float f69;
	highp float f70;
	f70 = View_ReflectionCubemapMaxMip;
	f69 = f70;
	f67 = (bool(h66))?(f68):(f69);
	vec4 v71;
	float h72;
	h72 = f67;
	highp float f73;
	f73 = (-2.386314e+00+h72);
	v71.xyzw = textureLod(ps0,v18,f73);
	if (bool(h66))
	{
		vec3 v74;
		v74.xyz = View_SkyLightColor.xyz;
		v65.xyz = (v71.xyz*v74);
	}
	else
	{
		vec3 v75;
		v75.xyz = (v71.xyz*vec3((v71.w*1.600000e+01)));
		float h76;
		h76 = pu_h[0].x;
		v65.xyz = ((v75*v75)*vec3(h76));
	}
	highp vec3 v77;
	highp vec4 v78;
	v78.w = 1.000000e+00;
	...
	v79.xyz = v14;
	v78.xyz = v79;
	v77.x = dot(View_SkyIrradianceEnvironmentMap[0],v78);
	v77.y = dot(View_SkyIrradianceEnvironmentMap[1],v78);
	v77.z = dot(View_SkyIrradianceEnvironmentMap[2],v78);
	highp vec3 v80;
	v80.xyz = v20;
	highp float f81;
	f81 = 1.000000e+00;
	vec3 v82;
	v82.xyz = (((max(vec3(0.000000e+00,0.000000e+00,0.000000e+00),v77)*View_SkyLightColor.xyz)*v80)*vec3(f81));
	v1.xyz = ((((v57+((v65*vec3(h41))*v21))+v82)*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v1.w = 0.000000e+00;
	float h83;
