...
void main()
{
	...
	v3.xyzw = v4;
	vec3 v5;
	v5.xyz = (cross(v3.xyz,v1)*v3.www);
	vec3 v6;
	float h7;
	vec3 v8;
	v8.xyz = normalize((-in_TEXCOORD8.xyz));
	v6.xyz = v8;
	highp float f9;
	f9 = Primitive_InvNonUniformScaleAndDeterminantSign.w;
	float h10;
	h10 = (View_CullingSign*f9);
	h7 = h10;
	highp int i11;
	i11 = (b0)?(1):(-1);
	h7 = (h7*float(i11));
	vec3 v12;
	vec3 v13;
	v13.xyz = vec3(0.000000e+00,0.000000e+00,1.000000e+00);
	highp vec3 v14;
	v14.xyz = ((v3.xyz*v13.zzz)+((v5*v13.yyy)+(v1*v13.xxx)));
	vec3 v15;
	v15.xyz = normalize(v14);
	v12.xyz = v15;
	v12.xyz = (v12*vec3(h7));
	vec3 v16;
	v16.xyz = ((-v6)+((v12*vec3(dot(v12,v6)))*vec3(2.000000e+00,2.000000e+00,2.000000e+00)));
	vec3 v17;
	vec2 v18;
	vec2 v19;
	v19.xy = ((vec2(-1.040000e+00,1.040000e+00)*vec2(((min(6.400000e-01,exp2((-9.280000e+00*max(dot(v12,v6),0.000000e+00))))*8.000000e-01)+3.700000e-02)))+vec2(9.255999e-01,-3.560000e-02));
	v18.xy = v19;
	v18.y = v19.y;
	v17.xyz = ((vec3(8.000000e-02,8.000000e-02,8.000000e-02)*v19.xxx)+v18.yyy);
	highp vec2 v20;
	v20.xy = (in_TEXCOORD4.xy*vec2(1.000000e+00,5.000000e-01));
	vec3 v21;
	v21.xyz = ((texture(ps1,v20).xyz*PrecomputedLightingBuffer_LightMapScale[0].xyz)+PrecomputedLightingBuffer_LightMapAdd[0].xyz);
	float h22;
	...
	float h25;
	highp vec4 v26;
	v26.xyzw = ((texture(ps1,(v20+vec2(0.000000e+00,5.000000e-01)))*PrecomputedLightingBuffer_LightMapScale[1])+PrecomputedLightingBuffer_LightMapAdd[1]);
	float h27;
	...
	vec3 v42;
	highp vec3 v43;
	v43.xyz = (v28*vec3(3.275794e-02,4.050453e-02,5.729167e-02));
	highp vec3 v44;
	v44.xyz = v12;
	highp vec3 v45;
	...
	highp vec3 v49;
	v49.xyz = (vec3(3.275794e-02,4.050453e-02,5.729167e-02)+(v17*vec3((3.000000e-01*h48))));
	vec3 v50;
	...
	h59 = f54;
	highp float f60;
	f60 = (-4.786314e+00+h59);
	v58.xyzw = textureLod(ps0,v16,f60);
	if (bool(h53))
	{
		vec3 v61;
	...
	vec4 v67;
	highp vec3 v68;
	v68.xyz = vec3(3.275794e-02,4.050453e-02,5.729167e-02);
	highp float f69;
	f69 = 1.000000e+00;
	vec3 v70;
	v70.xyz = (((max(vec3(0.000000e+00,0.000000e+00,0.000000e+00),v64)*View_SkyLightColor.xyz)*v68)*vec3(f69));
	v67.xyz = ((((v42+((v52*v29.www)*v17))+v70)*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v67.w = 6.500000e-01;
	out_Target0.xyzw = v67;
}
