...
void main()
{
	...
	vec3 v8;
	vec2 v9;
	v9.xy = ((texture(ps2,in_TEXCOORD0).xy*vec2(2.000000e+00,2.000000e+00))+vec2(-1.000000e+00,-1.000000e+00));
	vec4 v10;
	v10.w = 1.000000e+00;
	v10.xy = v9;
	...
	vec3 v15;
	v15.xyz = clamp(texture(ps1,in_TEXCOORD0).xyz,vec3(0.000000e+00,0.000000e+00,0.000000e+00),vec3(1.000000e+00,1.000000e+00,1.000000e+00));
	vec3 v16;
	vec2 v17;
	vec2 v18;
	v18.xy = ((vec2(-1.040000e+00,1.040000e+00)*vec2(((min(2.500000e-01,exp2((-9.280000e+00*max(dot(v8,v6),0.000000e+00))))*5.000000e-01)+2.875000e-02)))+vec2(7.539999e-01,-2.900000e-02));
	v17.xy = v18;
	v17.y = v18.y;
	v16.xyz = ((vec3(4.800000e-02,4.800000e-02,4.800000e-02)*v18.xxx)+v17.yyy);
	vec4 v19;
	vec4 v20;
	float h21;
	vec4 v22;
	vec4 v23;
	v22.x = 2.820950e-01;
	v22.y = (-4.886030e-01*v8.y);
	v22.z = (4.886030e-01*v8.z);
	v22.w = (-4.886030e-01*v8.x);
	vec3 v24;
	v24.xyz = (v8*v8);
	v23.x = ((1.092548e+00*v8.x)*v8.y);
	v23.y = ((-1.092548e+00*v8.y)*v8.z);
	v23.z = (3.153920e-01*((3.000000e+00*v24.z)+-1.000000e+00));
	v23.w = ((-1.092548e+00*v8.x)*v8.z);
	v19.xyzw = v22;
	v19.x = 8.862275e-01;
	...
	v37.xyz = (v15*v35);
	vec3 v38;
	v38.xyz = (v37*View_IndirectLightingColorScale);
	v1.xyz = v38;
	float h39;
	h39 = (((Primitive_UseSingleSampleShadowFromStationaryLights>0.000000e+00)&&(View_IndirectLightingCacheShowFlag>0.000000e+00)))?(IndirectLightingCache_DirectionalLightShadowing):(1.000000e+00);
	highp vec3 v40;
	highp vec3 v41;
	v41.xyz = v6;
	highp vec3 v42;
	v42.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	v40.xyz = normalize((v41+v42));
	highp vec3 v43;
	vec3 v44;
	v44.xyz = v40;
	highp vec3 v45;
	v45.xyz = cross(v8,v44);
	v43.xyz = v45;
	highp float f46;
	highp vec3 v47;
	v47.xyz = v8;
	float h48;
	h48 = max(0.000000e+00,dot(v47,v40));
	highp float f49;
	f49 = (h48*2.500000e-01);
	f46 = f49;
	highp float f50;
	highp float f51;
	f51 = 2.500000e-01;
	f50 = (f51/(dot(v43,v43)+(f46*f46)));
	vec3 v52;
	highp vec3 v53;
	v53.xyz = v8;
	highp vec3 v54;
	v54.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	highp float f55;
	f55 = h39;
	highp vec3 v56;
	v56.xyz = MobileDirectionalLight_DirectionalLightColor.xyz;
	float h57;
	h57 = min((f50*f50),6.550400e+04);
	highp vec3 v58;
	v58.xyz = (v15+(v16*vec3((3.750000e-01*h57))));
	vec3 v59;
	v59.xyz = ((vec3((f55*max(0.000000e+00,dot(v53,v54))))*v56)*v58);
	v52.xyz = (v1+v59);
	vec3 v60;
	float h61;
	h61 = float((pu_h[0].w>0.000000e+00));
	highp float f62;
	highp float f63;
	f63 = pu_h[0].w;
	highp float f64;
	highp float f65;
	f65 = View_ReflectionCubemapMaxMip;
	f64 = f65;
	f62 = (bool(h61))?(f63):(f64);
	vec4 v66;
	float h67;
	h67 = f62;
	highp float f68;
	f68 = (-3.200000e+00+h67);
	v66.xyzw = textureLod(ps0,v14,f68);
	if (bool(h61))
	{
		vec3 v69;
		v69.xyz = View_SkyLightColor.xyz;
		v60.xyz = (v66.xyz*v69);
	}
	else
	{
		vec3 v70;
		v70.xyz = (v66.xyz*vec3((v66.w*1.600000e+01)));
		float h71;
		h71 = pu_h[0].x;
		v60.xyz = ((v70*v70)*vec3(h71));
	}
	highp vec3 v72;
	highp vec4 v73;
	v73.w = 1.000000e+00;
	...
	v74.xyz = v8;
	v73.xyz = v74;
	v72.x = dot(View_SkyIrradianceEnvironmentMap[0],v73);
	v72.y = dot(View_SkyIrradianceEnvironmentMap[1],v73);
	v72.z = dot(View_SkyIrradianceEnvironmentMap[2],v73);
	highp vec3 v75;
	v75.xyz = v15;
	highp float f76;
	f76 = 1.000000e+00;
	vec3 v77;
	v77.xyz = (((max(vec3(0.000000e+00,0.000000e+00,0.000000e+00),v72)*View_SkyLightColor.xyz)*v75)*vec3(f76));
	v0.xyz = ((((v52+((v60*vec3(h36))*v16))+v77)*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v0.w = 0.000000e+00;
	float h78;
	h78 = min(in_TEXCOORD8.w,6.550000e+04);
	v0.w = h78;
	out_Target0.xyzw = v0;
}
