...
void main()
{
	...
	vec3 v12;
	v12.xyz = (pow(max(v11.xyz,vec3(0.000000e+00,0.000000e+00,0.000000e+00)),vec3(2.000000e+00,2.000000e+00,2.000000e+00))*vec3(5.000000e+00,5.000000e+00,5.000000e+00));
	float h13;
	h13 = clamp(pow(max(v11.w,0.000000e+00),1.750000e+00),0.000000e+00,1.000000e+00);
	float h14;
	...
	v57.xyz = v6;
	v56.xyz = v57;
	v55.x = dot(View_SkyIrradianceEnvironmentMap[0],v56);
	v55.y = dot(View_SkyIrradianceEnvironmentMap[1],v56);
	v55.z = dot(View_SkyIrradianceEnvironmentMap[2],v56);
	vec4 v58;
	highp vec3 v59;
	v59.xyz = vec3(0.000000e+00,0.000000e+00,0.000000e+00);
	highp float f60;
	f60 = 1.000000e+00;
	vec3 v61;
	v61.xyz = (((max(vec3(0.000000e+00,0.000000e+00,0.000000e+00),v55)*View_SkyLightColor.xyz)*v59)*vec3(f60));
	v58.xyz = (((((v33+((v43*vec3(h18))*vec3(h14)))+v61)+max(v12,vec3(0.000000e+00,0.000000e+00,0.000000e+00)))*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v58.w = h13;
	out_Target0.xyzw = v58;
}
