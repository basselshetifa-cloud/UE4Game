...
void main()
{
	...
	v77.xyz = v78;
	highp vec4 v79;
	v79.xyzw = ((texture(ps3,(v74+vec2(0.000000e+00,5.000000e-01)))*PrecomputedLightingBuffer_LightMapScale[1])+PrecomputedLightingBuffer_LightMapAdd[1]);
	float h80;
	h80 = max(0.000000e+00,dot(v79,v77));
	highp vec3 v81;
	v81.xyz = ((v75*vec3((((exp2(((h76*1.600000e+01)+-8.000000e+00))+-3.906250e-03)*h80)/h76)))*v73);
	highp vec3 v82;
	v82.xyz = v7;
	highp vec3 v83;
	v83.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	highp float f84;
	f84 = 0.000000e+00;
	highp vec3 v85;
	v85.xyz = MobileDirectionalLight_DirectionalLightColor.xyz;
	highp vec3 v86;
	v86.xyz = v73;
	vec3 v87;
	v87.xyz = (v81*View_IndirectLightingColorScale);
	vec3 v88;
	v88.xyz = ((vec3((f84*max(0.000000e+00,dot(v82,v83))))*v85)*v86);
	v0.xyz = ((((v87+v88)+max(v41,vec3(0.000000e+00,0.000000e+00,0.000000e+00)))*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v0.w = 0.000000e+00;
	float h89;
	h89 = min(in_TEXCOORD8.w,6.550000e+04);
	v0.w = h89;
	out_Target0.xyzw = v0;
}
