...
void main()
{
	...
	v0.w = 0.000000e+00;
	vec2 v1;
	v1.xy = in_TEXCOORD0.xy;
	vec3 v2;
	v2.xyz = View_WorldCameraOrigin;
	vec3 v3;
	v3.xyz = View_ViewToTranslatedWorld[2].xyz;
	v0.xyz = (max(vec3(pow(max((1.000000e+00+(-min(max(((abs((v1.y+-5.000000e-01))+(-mix(0.000000e+00,5.000000e-01,((min(max(v2.y,0.000000e+00),3.500000e+04)/3.500000e+04)*(1.000000e+00+(-min(max(dot(vec3(0.000000e+00,0.000000e+00,-1.000000e+00),v3),0.000000e+00),1.000000e+00)))))))/1.000000e-01),0.000000e+00),1.000000e+00))),0.000000e+00),1.000000e+00)),vec3(0.000000e+00,0.000000e+00,0.000000e+00))*in_TEXCOORD7.www);
	out_Target0.xyzw = v0;
}
