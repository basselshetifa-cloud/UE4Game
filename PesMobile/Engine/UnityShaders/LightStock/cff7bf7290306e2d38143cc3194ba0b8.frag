...
void main()
{
	...
	vec2 v14;
	vec2 v15;
	v15.xy = ((vec2(-1.040000e+00,1.040000e+00)*vec2(((min(6.400000e-01,exp2((-9.280000e+00*max(dot(v7,v5),0.000000e+00))))*8.000000e-01)+3.700000e-02)))+vec2(9.255999e-01,-3.560000e-02));
	v14.xy = v15;
	v14.y = v15.y;
	v13.xyz = ((vec3(4.800000e-02,4.800000e-02,4.800000e-02)*v15.xxx)+v14.yyy);
	vec4 v16;
	vec4 v17;
	float h18;
	vec4 v19;
	vec4 v20;
	v19.x = 2.820950e-01;
	v19.y = (-4.886030e-01*v7.y);
	v19.z = (4.886030e-01*v7.z);
	v19.w = (-4.886030e-01*v7.x);
	vec3 v21;
	v21.xyz = (v7*v7);
	v20.x = ((1.092548e+00*v7.x)*v7.y);
	v20.y = ((-1.092548e+00*v7.y)*v7.z);
	v20.z = (3.153920e-01*((3.000000e+00*v21.z)+-1.000000e+00));
	v20.w = ((-1.092548e+00*v7.x)*v7.z);
	v16.xyzw = v19;
	v16.x = 8.862275e-01;
	v16.yzw = (v19.yzw*vec3(2.094395e+00,2.094395e+00,2.094395e+00));
	v17.xyzw = (v20*vec4(7.853982e-01,7.853982e-01,7.853982e-01,7.853982e-01));
	h18 = (4.290426e-01*(v21.x+(-v21.y)));
	vec3 v22;
	v22.xyz = vec3(0.000000e+00,0.000000e+00,0.000000e+00);
	vec4 v23;
	v23.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients0[0];
	vec4 v24;
	v24.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients1[0];
	float h25;
	h25 = IndirectLightingCache_IndirectLightingSHCoefficients2.x;
	v22.x = ((dot(v23,v16)+dot(v24,v17))+(h25*h18));
	vec4 v26;
	v26.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients0[1];
	vec4 v27;
	v27.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients1[1];
	float h28;
	h28 = IndirectLightingCache_IndirectLightingSHCoefficients2.y;
	v22.y = ((dot(v26,v16)+dot(v27,v17))+(h28*h18));
	vec4 v29;
	v29.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients0[2];
	vec4 v30;
	v30.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients1[2];
	float h31;
	h31 = IndirectLightingCache_IndirectLightingSHCoefficients2.z;
	v22.z = ((dot(v29,v16)+dot(v30,v17))+(h31*h18));
	vec3 v32;
	v32.xyz = max(vec3(0.000000e+00,0.000000e+00,0.000000e+00),v22);
	float h33;
	h33 = dot(v32,vec3(3.000000e-01,5.900000e-01,1.100000e-01));
	highp vec3 v34;
	highp vec3 v35;
	v35.xyz = v5;
	highp vec3 v36;
	v36.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	v34.xyz = normalize((v35+v36));
	highp vec3 v37;
	vec3 v38;
	v38.xyz = v34;
	highp vec3 v39;
	v39.xyz = cross(v7,v38);
	v37.xyz = v39;
	highp float f40;
	highp vec3 v41;
	v41.xyz = v7;
	float h42;
	h42 = max(0.000000e+00,dot(v41,v34));
	highp float f43;
	f43 = (h42*4.000000e-02);
	f40 = f43;
	highp float f44;
	highp float f45;
	f45 = 4.000000e-02;
	f44 = (f45/(dot(v37,v37)+(f40*f40)));
	vec3 v46;
	highp vec3 v47;
	v47.xyz = (v12*v32);
	highp vec3 v48;
	v48.xyz = v7;
	highp vec3 v49;
	v49.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	highp float f50;
	f50 = 1.000000e+00;
	highp vec3 v51;
	v51.xyz = MobileDirectionalLight_DirectionalLightColor.xyz;
	float h52;
	h52 = min((f44*f44),6.550400e+04);
	highp vec3 v53;
	v53.xyz = (v12+(v13*vec3((3.000000e-01*h52))));
	vec3 v54;
	v54.xyz = (v47*View_IndirectLightingColorScale);
	vec3 v55;
	v55.xyz = ((vec3((f50*max(0.000000e+00,dot(v48,v49))))*v51)*v53);
	v46.xyz = (v54+v55);
	vec3 v56;
	float h57;
	...
	h63 = f58;
	highp float f64;
	f64 = (-4.786314e+00+h63);
	v62.xyzw = textureLod(ps0,v11,f64);
	if (bool(h57))
	{
		vec3 v65;
	...
	v0.xyz = ((((v46+((v56*vec3(h33))*v13))+v73)*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v0.w = 0.000000e+00;
	float h74;
