...
void main()
{
	...
	float h13;
	h13 = ((min(4.900000e-01,exp2((-9.280000e+00*max(dot(v7,v5),0.000000e+00))))*7.000000e-01)+3.425000e-02);
	vec4 v14;
	vec4 v15;
	float h16;
	vec4 v17;
	...
	highp vec3 v51;
	v51.xyz = (v12+vec3((h13*(3.250000e-01*h50))));
	vec3 v52;
