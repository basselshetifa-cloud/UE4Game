...
void main()
{
	...
	vec2 v17;
	vec2 v18;
	v18.xy = ((vec2(-1.040000e+00,1.040000e+00)*vec2(((min(1.225000e-01,exp2((-9.280000e+00*max(dot(v7,v5),0.000000e+00))))*3.500000e-01)+2.462500e-02)))+vec2(6.682000e-01,-2.570000e-02));
	v17.xy = v18;
	...
	highp vec3 v56;
	v56.xyz = (v14+(v16*vec3((4.125000e-01*h55))));
	vec3 v57;
	...
	v0.xyz = (((v49+((v59*vec3(h36))*v16))*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v0.w = 0.000000e+00;
	float h71;
	h71 = min(in_TEXCOORD8.w,6.550000e+04);
	v0.w = h71;
	out_Target0.xyzw = v0;
}
