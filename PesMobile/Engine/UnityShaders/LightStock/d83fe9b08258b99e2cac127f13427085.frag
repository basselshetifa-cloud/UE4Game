...
void main()
{
	...
	float h19;
	h19 = ((min(6.250000e-02,exp2((-9.280000e+00*max(dot(v13,v7),0.000000e+00))))*2.500000e-01)+2.187500e-02);
	highp vec2 v20;
	...
	highp vec3 v49;
	v49.xyz = (v18+vec3((h19*(4.375000e-01*h48))));
	vec3 v50;
	...
	v1.xyz = (((v42+((v52*v29.www)*vec3(h19)))*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v1.w = 0.000000e+00;
	float h64;
