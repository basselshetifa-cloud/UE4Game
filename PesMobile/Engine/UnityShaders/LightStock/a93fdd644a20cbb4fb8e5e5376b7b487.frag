...
{
	vec4 v0;
	v0.xyz = ((vec3(8.000000e-01,8.000000e-01,8.000000e-01)*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v0.w = clamp(texture(ps0,in_TEXCOORD0.xy).w,0.000000e+00,1.000000e+00);
	out_Target0.xyzw = v0;
}
