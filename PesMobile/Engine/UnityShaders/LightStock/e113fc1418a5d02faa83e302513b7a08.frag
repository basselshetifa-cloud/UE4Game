...
void main()
{
	...
	v77.xyz = v13;
	v76.xyz = v77;
	v75.x = dot(View_SkyIrradianceEnvironmentMap[0],v76);
	v75.y = dot(View_SkyIrradianceEnvironmentMap[1],v76);
	v75.z = dot(View_SkyIrradianceEnvironmentMap[2],v76);
	highp vec3 v78;
	v78.xyz = v19;
	highp float f79;
	f79 = 1.000000e+00;
	vec3 v80;
	v80.xyz = (((max(vec3(0.000000e+00,0.000000e+00,0.000000e+00),v75)*View_SkyLightColor.xyz)*v78)*vec3(f79));
	v1.xyz = ((((v53+((v63*vec3(h40))*v20))+v80)*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v1.w = 0.000000e+00;
	float h81;
	h81 = min(in_TEXCOORD8.w,6.550000e+04);
	v1.w = h81;
	out_Target0.xyzw = v1;
}
