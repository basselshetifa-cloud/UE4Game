...
INTERFACE_LOCATION(2) out highp vec4 var_TEXCOORD4;
...
void main()
{
	...
	v55.w = h18;
	highp vec4 v56;
	v56.xyzw = vec4(0.000000e+00,0.000000e+00,0.000000e+00,0.000000e+00);
	v56.xy = ((in_ATTRIBUTE15*PrecomputedLightingBuffer_LightMapCoordinateScaleBias.xy)+PrecomputedLightingBuffer_LightMapCoordinateScaleBias.zw);
	v56.zw = vec2(0.000000e+00,0.000000e+00);
	highp vec4 v57;
	v57.w = 0.000000e+00;
	highp vec3 v58;
	v58.xyz = v9;
	...
	v1.w = v16.w;
	v0.xyzw = v16;
	var_TEXCOORD10.xyzw = v57;
	var_TEXCOORD11.xyzw = v59;
	var_TEXCOORD4.xyzw = v56;
