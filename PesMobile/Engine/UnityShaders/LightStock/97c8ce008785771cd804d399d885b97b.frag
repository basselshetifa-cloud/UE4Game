...
void main()
{
	...
	float h7;
	highp float f8;
	f8 = Primitive_InvNonUniformScaleAndDeterminantSign.w;
	float h9;
	h9 = (View_CullingSign*f8);
	h7 = h9;
	highp int i10;
	i10 = (b0)?(1):(-1);
	h7 = (h7*float(i10));
	vec3 v11;
	vec3 v12;
	v12.xyz = vec3(0.000000e+00,0.000000e+00,1.000000e+00);
	highp vec3 v13;
	v13.xyz = ((v4.xyz*v12.zzz)+((v6*v12.yyy)+(v2*v12.xxx)));
	vec3 v14;
	...
	v17.xyz = v11;
	v16.xyz = v17;
	v15.x = dot(View_SkyIrradianceEnvironmentMap[0],v16);
	v15.y = dot(View_SkyIrradianceEnvironmentMap[1],v16);
	v15.z = dot(View_SkyIrradianceEnvironmentMap[2],v16);
	highp vec3 v18;
	v18.xyz = vec3(0.000000e+00,0.000000e+00,0.000000e+00);
	highp vec3 v19;
	v19.xyz = v11;
	highp vec3 v20;
	v20.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	highp float f21;
	f21 = 1.000000e+00;
	highp vec3 v22;
	v22.xyz = MobileDirectionalLight_DirectionalLightColor.xyz;
	highp vec3 v23;
	v23.xyz = vec3(0.000000e+00,0.000000e+00,0.000000e+00);
	vec3 v24;
	v24.xyz = (v18*View_IndirectLightingColorScale);
	vec3 v25;
	v25.xyz = ((vec3((f21*max(0.000000e+00,dot(v19,v20))))*v22)*v23);
	highp vec3 v26;
	v26.xyz = vec3(0.000000e+00,0.000000e+00,0.000000e+00);
	highp float f27;
	f27 = 1.000000e+00;
	vec3 v28;
	v28.xyz = (((max(vec3(0.000000e+00,0.000000e+00,0.000000e+00),v15)*View_SkyLightColor.xyz)*v26)*vec3(f27));
	v1.xyz = ((((v24+v25)+v28)*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v1.w = 0.000000e+00;
	float h29;
	h29 = min(in_TEXCOORD8.w,6.550000e+04);
	v1.w = h29;
	out_Target0.xyzw = v1;
}
