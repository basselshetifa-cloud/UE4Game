...
void main()
{
	...
	vec3 v7;
	vec2 v8;
	v8.xy = ((texture(ps2,in_TEXCOORD0.xy).xy*vec2(2.000000e+00,2.000000e+00))+vec2(-1.000000e+00,-1.000000e+00));
	vec4 v9;
	v9.w = 1.000000e+00;
	v9.xy = v8;
	...
	vec3 v14;
	v14.xyz = clamp(texture(ps1,in_TEXCOORD0.xy).xyz,vec3(0.000000e+00,0.000000e+00,0.000000e+00),vec3(1.000000e+00,1.000000e+00,1.000000e+00));
	float h15;
	h15 = ((min(2.500000e-01,exp2((-9.280000e+00*max(dot(v7,v5),0.000000e+00))))*5.000000e-01)+2.875000e-02);
	highp vec2 v16;
	v16.xy = (in_TEXCOORD4.xy*vec2(1.000000e+00,5.000000e-01));
	vec3 v17;
	v17.xyz = ((texture(ps3,v16).xyz*PrecomputedLightingBuffer_LightMapScale[0].xyz)+PrecomputedLightingBuffer_LightMapAdd[0].xyz);
	float h18;
	h18 = dot(v17,vec3(3.000000e-01,5.900000e-01,1.100000e-01));
	highp vec4 v19;
	v19.w = 1.000000e+00;
	highp vec3 v20;
	v20.xyz = v7.yzx;
	...
	float h21;
	highp vec4 v22;
	v22.xyzw = ((texture(ps3,(v16+vec2(0.000000e+00,5.000000e-01)))*PrecomputedLightingBuffer_LightMapScale[1])+PrecomputedLightingBuffer_LightMapAdd[1]);
	float h23;
	h23 = max(0.000000e+00,dot(v22,v19));
	h21 = ((exp2(((h18*1.600000e+01)+-8.000000e+00))+-3.906250e-03)*h23);
	vec3 v24;
	v24.xyz = (v17*vec3((h21/h18)));
	vec4 v25;
	v25.xyz = v24;
	v25.w = h21;
	highp vec3 v26;
	...
	v27.xyz = v5;
	highp vec3 v28;
	v28.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	v26.xyz = normalize((v27+v28));
	highp vec3 v29;
	vec3 v30;
	v30.xyz = v26;
	highp vec3 v31;
	v31.xyz = cross(v7,v30);
	v29.xyz = v31;
	highp float f32;
	highp vec3 v33;
	v33.xyz = v7;
	float h34;
	h34 = max(0.000000e+00,dot(v33,v26));
	highp float f35;
	f35 = (h34*2.500000e-01);
	f32 = f35;
	highp float f36;
	highp float f37;
	f37 = 2.500000e-01;
	f36 = (f37/(dot(v29,v29)+(f32*f32)));
	vec3 v38;
	highp vec3 v39;
	v39.xyz = (v24*v14);
	highp vec3 v40;
	v40.xyz = v7;
	highp vec3 v41;
	v41.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	highp float f42;
	f42 = 1.000000e+00;
	highp vec3 v43;
	v43.xyz = MobileDirectionalLight_DirectionalLightColor.xyz;
	float h44;
	h44 = min((f36*f36),6.550400e+04);
	highp vec3 v45;
	v45.xyz = (v14+vec3((h15*(3.750000e-01*h44))));
	vec3 v46;
	v46.xyz = (v39*View_IndirectLightingColorScale);
	vec3 v47;
	v47.xyz = ((vec3((f42*max(0.000000e+00,dot(v40,v41))))*v43)*v45);
	v38.xyz = (v46+v47);
	vec3 v48;
	float h49;
	h49 = float((pu_h[0].w>0.000000e+00));
	highp float f50;
	highp float f51;
	f51 = pu_h[0].w;
	highp float f52;
	highp float f53;
	f53 = View_ReflectionCubemapMaxMip;
	f52 = f53;
	f50 = (bool(h49))?(f51):(f52);
	vec4 v54;
	float h55;
	h55 = f50;
	highp float f56;
	f56 = (-3.200000e+00+h55);
	v54.xyzw = textureLod(ps0,v13,f56);
	if (bool(h49))
	{
		vec3 v57;
		v57.xyz = View_SkyLightColor.xyz;
		v48.xyz = (v54.xyz*v57);
	}
	else
	{
		vec3 v58;
		v58.xyz = (v54.xyz*vec3((v54.w*1.600000e+01)));
		float h59;
		h59 = pu_h[0].x;
		v48.xyz = ((v58*v58)*vec3(h59));
	}
	highp vec3 v60;
	highp vec4 v61;
	v61.w = 1.000000e+00;
	...
	v62.xyz = v7;
	v61.xyz = v62;
	v60.x = dot(View_SkyIrradianceEnvironmentMap[0],v61);
	v60.y = dot(View_SkyIrradianceEnvironmentMap[1],v61);
	v60.z = dot(View_SkyIrradianceEnvironmentMap[2],v61);
	highp vec3 v63;
	v63.xyz = v14;
	highp float f64;
	f64 = 1.000000e+00;
	vec3 v65;
	v65.xyz = (((max(vec3(0.000000e+00,0.000000e+00,0.000000e+00),v60)*View_SkyLightColor.xyz)*v63)*vec3(f64));
	v0.xyz = ((((v38+((v48*v25.www)*vec3(h15)))+v65)*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v0.w = 0.000000e+00;
	float h66;
	h66 = min(in_TEXCOORD8.w,6.550000e+04);
	v0.w = h66;
	out_Target0.xyzw = v0;
}
