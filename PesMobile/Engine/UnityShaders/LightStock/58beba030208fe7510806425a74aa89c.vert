...
INTERFACE_LOCATION(3) out highp vec4 var_TEXCOORD8;
void main()
{
	highp vec4 v0;
	highp vec4 v1;
	...
	highp mat3 m24;
	highp mat3 m25;
	m25[0].xyz = Primitive_LocalToWorld[0].xyz;
	m25[1].xyz = Primitive_LocalToWorld[1].xyz;
	m25[2].xyz = Primitive_LocalToWorld[2].xyz;
	m24 = m25;
	highp float f26;
	f26 = Primitive_InvNonUniformScaleAndDeterminantSign.x;
	m24[0].xyz = (m25[0]*vec3(f26));
	highp float f27;
	f27 = Primitive_InvNonUniformScaleAndDeterminantSign.y;
	m24[1].xyz = (m24[1]*vec3(f27));
	highp float f28;
	f28 = Primitive_InvNonUniformScaleAndDeterminantSign.z;
	m24[2].xyz = (m24[2]*vec3(f28));
	highp vec4 v29;
	v29.xyz = ((v17.zzz*m24[2])+((v17.yyy*m24[1])+(v17.xxx*m24[0])));
	highp float f30;
	f30 = (in_ATTRIBUTE2.w*Primitive_InvNonUniformScaleAndDeterminantSign.w);
	v29.w = f30;
	v23.xyz = ((v14.zzz*m24[2])+((v14.yyy*m24[1])+(v14.xxx*m24[0])));
	v1.w = v22.w;
	v0.xyzw = v22;
	var_TEXCOORD10.xyzw = v23;
	var_TEXCOORD11.xyzw = v29;
