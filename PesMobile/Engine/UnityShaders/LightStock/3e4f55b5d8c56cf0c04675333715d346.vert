...
void main()
{
	...
	f20 = v18.z;
	highp float f29;
	f29 = max(0.000000e+00,MobileBasePass_Fog_ExponentialFogParameters.w);
	if ((f29>0.000000e+00))
	{
		highp float f30;
		f30 = (f29*f27);
		...
		f31 = (f30*v18.z);
		highp float f32;
		f32 = (View_WorldCameraOrigin.z+f31);
		f21 = ((1.000000e+00+(-f30))*f28);
		f20 = (v18.z+(-f31));
		f23 = (MobileBasePass_Fog_ExponentialFogParameters3.x*exp2((-max(-1.270000e+02,(MobileBasePass_Fog_ExponentialFogParameters.y*(f32+(-MobileBasePass_Fog_ExponentialFogParameters3.y)))))));
		f22 = (MobileBasePass_Fog_ExponentialFogParameters2.z*exp2((-max(-1.270000e+02,(MobileBasePass_Fog_ExponentialFogParameters2.y*(f32+(-MobileBasePass_Fog_ExponentialFogParameters2.w)))))));
	}
	highp float f33;
	highp float f34;
	f34 = max(-1.270000e+02,(MobileBasePass_Fog_ExponentialFogParameters.y*f20));
	highp float f35;
	f35 = ((1.000000e+00+(-exp2((-f34))))/f34);
	highp float f36;
	f36 = (6.931472e-01+(-(2.402265e-01*f34)));
	highp float f37;
	f37 = abs(f34);
	highp float f38;
	f38 = ((f37>1.000000e-02))?(f35):(f36);
	f33 = (f23*f38);
	highp float f39;
	f39 = max(-1.270000e+02,(MobileBasePass_Fog_ExponentialFogParameters2.y*f20));
	highp float f40;
	f40 = ((1.000000e+00+(-exp2((-f39))))/f39);
	highp float f41;
	f41 = (6.931472e-01+(-(2.402265e-01*f39)));
	highp float f42;
	f42 = abs(f39);
	highp float f43;
	f43 = ((f42>1.000000e-02))?(f40):(f41);
	highp float f44;
	f44 = h24;
	float h45;
	h45 = max(clamp(exp2((-((f33+(f22*f43))*f21))),0.000000e+00,1.000000e+00),f44);
	h19 = h45;
	...
	v46.w = h19;
	highp vec4 t47[1];
	t47[0].xyzw = vec4(0.000000e+00,0.000000e+00,0.000000e+00,0.000000e+00);
	t47[(0/2)].xy = t15[0];
	highp vec4 v48;
	v48.w = 0.000000e+00;
	highp vec3 v49;
	...
	v1.w = v17.w;
	v0.xyzw = v17;
	var_TEXCOORD10.xyzw = v48;
	var_TEXCOORD11.xyzw = v50;
	var_TEXCOORD0.xyzw = t47[0];
