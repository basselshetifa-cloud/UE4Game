...
void main()
{
	...
	v16.xyz = v11;
	highp vec3 v17;
	v17.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	highp float f18;
	f18 = 1.000000e+00;
	highp vec3 v19;
	v19.xyz = MobileDirectionalLight_DirectionalLightColor.xyz;
	highp vec3 v20;
	v20.xyz = vec3(0.000000e+00,0.000000e+00,0.000000e+00);
	vec3 v21;
	v21.xyz = (v15*View_IndirectLightingColorScale);
	vec3 v22;
	v22.xyz = ((vec3((f18*max(0.000000e+00,dot(v16,v17))))*v19)*v20);
	v1.xyz = (((v21+v22)*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v1.w = 0.000000e+00;
	float h23;
	h23 = min(in_TEXCOORD8.w,6.550000e+04);
	v1.w = h23;
	out_Target0.xyzw = v1;
}
