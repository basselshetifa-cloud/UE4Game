...
INTERFACE_LOCATION(0) in highp vec2 in_ATTRIBUTE0;
...
void main()
{
	...
	highp vec4 v2;
	v2.xyzw = v1;
	v2.xy = (vec2(-1.000000e+00,-1.000000e+00)+((vec2(2.000000e+00,2.000000e+00)*(DrawRectangleParameters_PosScaleBias.zw+(in_ATTRIBUTE0*DrawRectangleParameters_PosScaleBias.xy)))*DrawRectangleParameters_InvTargetSizeAndTextureSize.xy));
	v2.xy = (v2.xy*vec2(1.000000e+00,-1.000000e+00));
	v0.xyzw = v2;
	var_TEXCOORD0.xy = ((DrawRectangleParameters_UVScaleBias.zw+(in_ATTRIBUTE1*DrawRectangleParameters_UVScaleBias.xy))*DrawRectangleParameters_InvTargetSizeAndTextureSize.zw);
