...
void main()
{
	...
	v65.xyz = v66;
	highp vec4 v67;
	v67.xyzw = ((texture(ps4,(v62+vec2(0.000000e+00,5.000000e-01)))*PrecomputedLightingBuffer_LightMapScale[1])+PrecomputedLightingBuffer_LightMapAdd[1]);
	float h68;
	h68 = max(0.000000e+00,dot(v67,v65));
	highp vec3 v69;
	v69.xyz = ((v63*vec3((((exp2(((h64*1.600000e+01)+-8.000000e+00))+-3.906250e-03)*h68)/h64)))*v61);
	highp vec3 v70;
	v70.xyz = v7;
	highp vec3 v71;
	v71.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	highp float f72;
	f72 = 1.000000e+00;
	highp vec3 v73;
	v73.xyz = MobileDirectionalLight_DirectionalLightColor.xyz;
	highp vec3 v74;
	v74.xyz = v61;
	vec3 v75;
	v75.xyz = (v69*View_IndirectLightingColorScale);
	vec3 v76;
	v76.xyz = ((vec3((f72*max(0.000000e+00,dot(v70,v71))))*v73)*v74);
	v0.xyz = ((((v75+v76)+max(v45,vec3(0.000000e+00,0.000000e+00,0.000000e+00)))*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v0.w = 0.000000e+00;
	float h77;
