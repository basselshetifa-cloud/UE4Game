...
void main()
{
	...
	vec3 v7;
	vec2 v8;
	v8.xy = ((texture(ps2,in_TEXCOORD0).xy*vec2(2.000000e+00,2.000000e+00))+vec2(-1.000000e+00,-1.000000e+00));
	vec4 v9;
	v9.w = 1.000000e+00;
	v9.xy = v8;
	...
	vec3 v14;
	v14.xyz = clamp(texture(ps1,in_TEXCOORD0).xyz,vec3(0.000000e+00,0.000000e+00,0.000000e+00),vec3(1.000000e+00,1.000000e+00,1.000000e+00));
	vec3 v15;
	vec2 v16;
	vec2 v17;
	v17.xy = ((vec2(-1.040000e+00,1.040000e+00)*vec2(((min(2.500000e-01,exp2((-9.280000e+00*max(dot(v7,v5),0.000000e+00))))*5.000000e-01)+2.875000e-02)))+vec2(7.539999e-01,-2.900000e-02));
	v16.xy = v17;
	v16.y = v17.y;
	v15.xyz = ((vec3(4.800000e-02,4.800000e-02,4.800000e-02)*v17.xxx)+v16.yyy);
	vec4 v18;
	vec4 v19;
	float h20;
	vec4 v21;
	vec4 v22;
	v21.x = 2.820950e-01;
	v21.y = (-4.886030e-01*v7.y);
	v21.z = (4.886030e-01*v7.z);
	v21.w = (-4.886030e-01*v7.x);
	vec3 v23;
	v23.xyz = (v7*v7);
	v22.x = ((1.092548e+00*v7.x)*v7.y);
	v22.y = ((-1.092548e+00*v7.y)*v7.z);
	v22.z = (3.153920e-01*((3.000000e+00*v23.z)+-1.000000e+00));
	v22.w = ((-1.092548e+00*v7.x)*v7.z);
	v18.xyzw = v21;
	v18.x = 8.862275e-01;
	v18.yzw = (v21.yzw*vec3(2.094395e+00,2.094395e+00,2.094395e+00));
	v19.xyzw = (v22*vec4(7.853982e-01,7.853982e-01,7.853982e-01,7.853982e-01));
	h20 = (4.290426e-01*(v23.x+(-v23.y)));
	vec3 v24;
	v24.xyz = vec3(0.000000e+00,0.000000e+00,0.000000e+00);
	vec4 v25;
	v25.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients0[0];
	vec4 v26;
	v26.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients1[0];
	float h27;
	h27 = IndirectLightingCache_IndirectLightingSHCoefficients2.x;
	v24.x = ((dot(v25,v18)+dot(v26,v19))+(h27*h20));
	vec4 v28;
	v28.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients0[1];
	vec4 v29;
	v29.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients1[1];
	float h30;
	h30 = IndirectLightingCache_IndirectLightingSHCoefficients2.y;
	v24.y = ((dot(v28,v18)+dot(v29,v19))+(h30*h20));
	vec4 v31;
	v31.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients0[2];
	vec4 v32;
	v32.xyzw = IndirectLightingCache_IndirectLightingSHCoefficients1[2];
	float h33;
	h33 = IndirectLightingCache_IndirectLightingSHCoefficients2.z;
	v24.z = ((dot(v31,v18)+dot(v32,v19))+(h33*h20));
	vec3 v34;
	v34.xyz = max(vec3(0.000000e+00,0.000000e+00,0.000000e+00),v24);
	float h35;
	h35 = dot(v34,vec3(3.000000e-01,5.900000e-01,1.100000e-01));
	highp vec3 v36;
	highp vec3 v37;
	v37.xyz = v5;
	highp vec3 v38;
	...
	v50.xyz = v7;
	highp vec3 v51;
	v51.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	highp float f52;
	f52 = 1.000000e+00;
	highp vec3 v53;
	v53.xyz = MobileDirectionalLight_DirectionalLightColor.xyz;
	float h54;
	h54 = min((f46*f46),6.550400e+04);
	highp vec3 v55;
	v55.xyz = (v14+(v15*vec3((3.750000e-01*h54))));
	vec3 v56;
	v56.xyz = (v49*View_IndirectLightingColorScale);
	vec3 v57;
	v57.xyz = ((vec3((f52*max(0.000000e+00,dot(v50,v51))))*v53)*v55);
	v48.xyz = (v56+v57);
	vec3 v58;
	float h59;
	h59 = float((pu_h[0].w>0.000000e+00));
	highp float f60;
	highp float f61;
	f61 = pu_h[0].w;
	highp float f62;
	highp float f63;
	f63 = View_ReflectionCubemapMaxMip;
	f62 = f63;
	f60 = (bool(h59))?(f61):(f62);
	vec4 v64;
	float h65;
	h65 = f60;
	highp float f66;
	f66 = (-3.200000e+00+h65);
	v64.xyzw = textureLod(ps0,v13,f66);
	if (bool(h59))
	{
		vec3 v67;
		v67.xyz = View_SkyLightColor.xyz;
		v58.xyz = (v64.xyz*v67);
	}
	else
	{
		vec3 v68;
		v68.xyz = (v64.xyz*vec3((v64.w*1.600000e+01)));
		float h69;
		h69 = pu_h[0].x;
		v58.xyz = ((v68*v68)*vec3(h69));
	}
	highp vec3 v70;
	highp vec4 v71;
	v71.w = 1.000000e+00;
	...
	v72.xyz = v7;
	v71.xyz = v72;
	v70.x = dot(View_SkyIrradianceEnvironmentMap[0],v71);
	v70.y = dot(View_SkyIrradianceEnvironmentMap[1],v71);
	v70.z = dot(View_SkyIrradianceEnvironmentMap[2],v71);
	highp vec3 v73;
	v73.xyz = v14;
	highp float f74;
	f74 = 1.000000e+00;
	vec3 v75;
	v75.xyz = (((max(vec3(0.000000e+00,0.000000e+00,0.000000e+00),v70)*View_SkyLightColor.xyz)*v73)*vec3(f74));
	v0.xyz = ((((v48+((v58*vec3(h35))*v15))+v75)*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v0.w = 0.000000e+00;
	float h76;
	h76 = min(in_TEXCOORD8.w,6.550000e+04);
	v0.w = h76;
	out_Target0.xyzw = v0;
}
