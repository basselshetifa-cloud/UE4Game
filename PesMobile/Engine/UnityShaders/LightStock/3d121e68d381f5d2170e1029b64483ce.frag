...
void main()
{
	...
	if (((texture(ps1,in_TEXCOORD0.xy).w+-3.333000e-01)<0.000000e+00)) discard;
	float h18;
	h18 = ((min(2.500000e-01,exp2((-9.280000e+00*max(dot(v13,v7),0.000000e+00))))*5.000000e-01)+2.875000e-02);
	highp vec2 v19;
	v19.xy = (in_TEXCOORD4.xy*vec2(1.000000e+00,5.000000e-01));
	vec3 v20;
	v20.xyz = ((texture(ps2,v19).xyz*PrecomputedLightingBuffer_LightMapScale[0].xyz)+PrecomputedLightingBuffer_LightMapAdd[0].xyz);
	float h21;
	h21 = dot(v20,vec3(3.000000e-01,5.900000e-01,1.100000e-01));
	highp vec4 v22;
	v22.w = 1.000000e+00;
	highp vec3 v23;
	v23.xyz = v13.yzx;
	...
	float h24;
	highp vec4 v25;
	v25.xyzw = ((texture(ps2,(v19+vec2(0.000000e+00,5.000000e-01)))*PrecomputedLightingBuffer_LightMapScale[1])+PrecomputedLightingBuffer_LightMapAdd[1]);
	float h26;
	h26 = max(0.000000e+00,dot(v25,v22));
	h24 = ((exp2(((h21*1.600000e+01)+-8.000000e+00))+-3.906250e-03)*h26);
	vec3 v27;
	v27.xyz = (v20*vec3((h24/h21)));
	vec4 v28;
	v28.xyz = v27;
	v28.w = h24;
	highp vec3 v29;
	...
	v30.xyz = v7;
	highp vec3 v31;
	v31.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	v29.xyz = normalize((v30+v31));
	highp vec3 v32;
	vec3 v33;
	v33.xyz = v29;
	highp vec3 v34;
	v34.xyz = cross(v13,v33);
	v32.xyz = v34;
	highp float f35;
	highp vec3 v36;
	v36.xyz = v13;
	float h37;
	h37 = max(0.000000e+00,dot(v36,v29));
	highp float f38;
	f38 = (h37*2.500000e-01);
	f35 = f38;
	highp float f39;
	highp float f40;
	f40 = 2.500000e-01;
	f39 = (f40/(dot(v32,v32)+(f35*f35)));
	vec3 v41;
	highp vec3 v42;
	v42.xyz = (v27*vec3(9.895834e-02,9.895834e-02,9.895834e-02));
	highp vec3 v43;
	v43.xyz = v13;
	highp vec3 v44;
	v44.xyz = MobileDirectionalLight_DirectionalLightDirectionAndShadowTransition.xyz;
	highp float f45;
	f45 = 1.000000e+00;
	highp vec3 v46;
	v46.xyz = MobileDirectionalLight_DirectionalLightColor.xyz;
	float h47;
	h47 = min((f39*f39),6.550400e+04);
	highp vec3 v48;
	v48.xyz = (vec3(9.895834e-02,9.895834e-02,9.895834e-02)+vec3((h18*(3.750000e-01*h47))));
	vec3 v49;
	v49.xyz = (v42*View_IndirectLightingColorScale);
	vec3 v50;
	v50.xyz = ((vec3((f45*max(0.000000e+00,dot(v43,v44))))*v46)*v48);
	v41.xyz = (v49+v50);
	vec3 v51;
	float h52;
	h52 = float((pu_h[0].w>0.000000e+00));
	highp float f53;
	highp float f54;
	f54 = pu_h[0].w;
	highp float f55;
	highp float f56;
	f56 = View_ReflectionCubemapMaxMip;
	f55 = f56;
	f53 = (bool(h52))?(f54):(f55);
	vec4 v57;
	float h58;
	h58 = f53;
	highp float f59;
	f59 = (-3.200000e+00+h58);
	v57.xyzw = textureLod(ps0,v17,f59);
	if (bool(h52))
	{
		vec3 v60;
		v60.xyz = View_SkyLightColor.xyz;
		v51.xyz = (v57.xyz*v60);
	}
	else
	{
		vec3 v61;
		v61.xyz = (v57.xyz*vec3((v57.w*1.600000e+01)));
		float h62;
		h62 = pu_h[0].x;
		v51.xyz = ((v61*v61)*vec3(h62));
	}
	highp vec3 v63;
	highp vec4 v64;
	v64.w = 1.000000e+00;
	...
	v65.xyz = v13;
	v64.xyz = v65;
	v63.x = dot(View_SkyIrradianceEnvironmentMap[0],v64);
	v63.y = dot(View_SkyIrradianceEnvironmentMap[1],v64);
	v63.z = dot(View_SkyIrradianceEnvironmentMap[2],v64);
	highp vec3 v66;
	v66.xyz = vec3(9.895834e-02,9.895834e-02,9.895834e-02);
	highp float f67;
	f67 = 1.000000e+00;
	vec3 v68;
	v68.xyz = (((max(vec3(0.000000e+00,0.000000e+00,0.000000e+00),v63)*View_SkyLightColor.xyz)*v66)*vec3(f67));
	v1.xyz = ((((v41+((v51*v28.www)*vec3(h18)))+v68)*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v1.w = 0.000000e+00;
	float h69;
	h69 = min(in_TEXCOORD8.w,6.550000e+04);
	v1.w = h69;
	out_Target0.xyzw = v1;
}
