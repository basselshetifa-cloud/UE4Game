...
void main()
{
	...
	vec2 v17;
	vec2 v18;
	v18.xy = ((vec2(-1.040000e+00,1.040000e+00)*vec2(((min(6.250000e-02,exp2((-9.280000e+00*max(dot(v7,v5),0.000000e+00))))*2.500000e-01)+2.187500e-02)))+vec2(6.109999e-01,-2.350000e-02));
	v17.xy = v18;
	...
	highp vec3 v56;
	v56.xyz = (v14+(v16*vec3((4.375000e-01*h55))));
	vec3 v57;
