...
{
#define Bones_BoneMatrices Bones_BoneMatricesvb3
...
INTERFACE_LOCATION(5) in highp vec2 in_ATTRIBUTE5;
INTERFACE_LOCATION(0) out highp vec4 var_TEXCOORD10;
INTERFACE_LOCATION(1) out highp vec4 var_TEXCOORD11;
INTERFACE_LOCATION(2) out highp vec2 var_TEXCOORD0;
INTERFACE_LOCATION(3) out vec4 var_TEXCOORD7;
INTERFACE_LOCATION(4) out highp vec4 var_TEXCOORD8;
void main()
{
	highp vec4 v0;
	highp vec4 v1;
	highp vec4 v2;
	highp int i3;
	i3 = int(in_ATTRIBUTE3.x);
	highp mat3x4 m4;
	m4[0].xyzw = in_ATTRIBUTE4.xxxx;
	m4[1].xyzw = in_ATTRIBUTE4.xxxx;
	m4[2].xyzw = in_ATTRIBUTE4.xxxx;
	highp int i5;
	i5 = int(in_ATTRIBUTE3.y);
	highp mat3x4 m6;
	m6[0].xyzw = in_ATTRIBUTE4.yyyy;
	m6[1].xyzw = in_ATTRIBUTE4.yyyy;
	m6[2].xyzw = in_ATTRIBUTE4.yyyy;
	highp int i7;
	i7 = int(in_ATTRIBUTE3.z);
	highp mat3x4 m8;
	m8[0].xyzw = in_ATTRIBUTE4.zzzz;
	m8[1].xyzw = in_ATTRIBUTE4.zzzz;
	m8[2].xyzw = in_ATTRIBUTE4.zzzz;
	highp int i9;
	i9 = int(in_ATTRIBUTE3.w);
	highp mat3x4 m10;
	m10[0].xyzw = in_ATTRIBUTE4.wwww;
	m10[1].xyzw = in_ATTRIBUTE4.wwww;
	m10[2].xyzw = in_ATTRIBUTE4.wwww;
	highp mat3x4 m11;
	m11 = (((matrixCompMult(m4,Bones_BoneMatrices[i3])+matrixCompMult(m6,Bones_BoneMatrices[i5]))+matrixCompMult(m8,Bones_BoneMatrices[i7]))+matrixCompMult(m10,Bones_BoneMatrices[i9]));
	highp vec4 v12;
	v12.w = 0.000000e+00;
	highp vec3 v13;
	v13.xyz = in_ATTRIBUTE1;
	v12.xyz = v13;
	highp vec3 v14;
	v14.x = dot(m11[0],v12);
	v14.y = dot(m11[1],v12);
	...
	highp vec4 v20;
	v20.w = 1.000000e+00;
	v20.xyz = ((((Primitive_LocalToWorld[0].xyz*v19.xxx)+(Primitive_LocalToWorld[1].xyz*v19.yyy))+(Primitive_LocalToWorld[2].xyz*v19.zzz))+(Primitive_LocalToWorld[3].xyz+View_PreViewTranslation));
	v2.xyzw = v20;
	highp vec3 v21;
	v21.xyz = vec3(0.000000e+00,0.000000e+00,0.000000e+00);
	v2.xyz = (v20.xyz+v21);
	highp vec4 v22;
	v22.xyzw = (View_TranslatedWorldToClip[3]+((View_TranslatedWorldToClip[2]*v2.zzzz)+((View_TranslatedWorldToClip[1]*v2.yyyy)+(View_TranslatedWorldToClip[0]*v2.xxxx))));
	v1.xyzw = v2;
	highp vec3 v23;
	v23.xyz = (v2.xyz+(-View_TranslatedWorldCameraOrigin));
	float h24;
	vec3 v25;
	highp float f26;
	highp float f27;
	...
	float h30;
	float h31;
	h31 = MobileBasePass_Fog_ExponentialFogColorParameter.w;
	h30 = h31;
	highp float f32;
	f32 = dot(v23,v23);
	highp float f33;
	...
	vec3 v35;
	vec3 v36;
	v36.xyz = (v23*vec3(f33));
	v35.xyz = v36;
	f29 = MobileBasePass_Fog_ExponentialFogParameters.x;
	f28 = MobileBasePass_Fog_ExponentialFogParameters2.x;
	f27 = f34;
	f26 = v23.z;
	highp float f37;
	f37 = max(0.000000e+00,MobileBasePass_Fog_ExponentialFogParameters.w);
	if ((f37>0.000000e+00))
	{
		highp float f38;
		f38 = (f37*f33);
		...
		f39 = (f38*v23.z);
		highp float f40;
		f40 = (View_WorldCameraOrigin.z+f39);
		f27 = ((1.000000e+00+(-f38))*f34);
		f26 = (v23.z+(-f39));
		f29 = (MobileBasePass_Fog_ExponentialFogParameters3.x*exp2((-max(-1.270000e+02,(MobileBasePass_Fog_ExponentialFogParameters.y*(f40+(-MobileBasePass_Fog_ExponentialFogParameters3.y)))))));
		f28 = (MobileBasePass_Fog_ExponentialFogParameters2.z*exp2((-max(-1.270000e+02,(MobileBasePass_Fog_ExponentialFogParameters2.y*(f40+(-MobileBasePass_Fog_ExponentialFogParameters2.w)))))));
	}
	highp float f41;
	highp float f42;
	f42 = max(-1.270000e+02,(MobileBasePass_Fog_ExponentialFogParameters.y*f26));
	highp float f43;
	f43 = ((1.000000e+00+(-exp2((-f42))))/f42);
	highp float f44;
	f44 = (6.931472e-01+(-(2.402265e-01*f42)));
	highp float f45;
	f45 = abs(f42);
	highp float f46;
	f46 = ((f45>1.000000e-02))?(f43):(f44);
	f41 = (f29*f46);
	highp float f47;
	f47 = max(-1.270000e+02,(MobileBasePass_Fog_ExponentialFogParameters2.y*f26));
	highp float f48;
	f48 = ((1.000000e+00+(-exp2((-f47))))/f47);
	highp float f49;
	f49 = (6.931472e-01+(-(2.402265e-01*f47)));
	highp float f50;
	f50 = abs(f47);
	highp float f51;
	f51 = ((f50>1.000000e-02))?(f48):(f49);
	highp float f52;
	f52 = (f41+(f28*f51));
	highp float f53;
	f53 = (f52*f27);
	vec3 v54;
	vec3 v55;
	v55.xyz = MobileBasePass_Fog_ExponentialFogColorParameter.xyz;
	v54.xyz = v55;
	...
	if ((MobileBasePass_Fog_InscatteringLightDirection.w>=0.000000e+00))
	{
		...
		v56.xyz = v35;
		float h57;
		h57 = clamp(exp2((-(f52*max((f27+(-MobileBasePass_Fog_InscatteringLightDirection.w)),0.000000e+00)))),0.000000e+00,1.000000e+00);
		vec3 v58;
		v58.xyz = (MobileBasePass_Fog_DirectionalInscatteringColor.xyz*vec3(pow(clamp(dot(v56,MobileBasePass_Fog_InscatteringLightDirection.xyz),0.000000e+00,1.000000e+00),MobileBasePass_Fog_DirectionalInscatteringColor.w)));
		v25.xyz = (v58*vec3((1.000000e+00+(-h57))));
	}
	highp float f59;
	f59 = h30;
	float h60;
	h60 = max(clamp(exp2((-f53)),0.000000e+00,1.000000e+00),f59);
	h24 = h60;
	if (((MobileBasePass_Fog_ExponentialFogParameters3.w>0.000000e+00)&&(f34>MobileBasePass_Fog_ExponentialFogParameters3.w)))
	{
		h24 = 1.000000e+00;
		v25.xyz = vec3(0.000000e+00,0.000000e+00,0.000000e+00);
	}
	vec4 v61;
	v61.xyz = ((v54*vec3((1.000000e+00+(-h24))))+v25);
	v61.w = h24;
	highp vec4 v62;
	v62.w = 0.000000e+00;
	highp mat3 m63;
	highp mat3 m64;
	m64[0].xyz = Primitive_LocalToWorld[0].xyz;
	m64[1].xyz = Primitive_LocalToWorld[1].xyz;
	m64[2].xyz = Primitive_LocalToWorld[2].xyz;
	m63 = m64;
	highp float f65;
	f65 = Primitive_InvNonUniformScaleAndDeterminantSign.x;
	m63[0].xyz = (m64[0]*vec3(f65));
	highp float f66;
	f66 = Primitive_InvNonUniformScaleAndDeterminantSign.y;
	m63[1].xyz = (m63[1]*vec3(f66));
	highp float f67;
	f67 = Primitive_InvNonUniformScaleAndDeterminantSign.z;
	m63[2].xyz = (m63[2]*vec3(f67));
	highp vec4 v68;
	v68.xyz = ((v17.zzz*m63[2])+((v17.yyy*m63[1])+(v17.xxx*m63[0])));
	highp float f69;
	f69 = (in_ATTRIBUTE2.w*Primitive_InvNonUniformScaleAndDeterminantSign.w);
	v68.w = f69;
	v62.xyz = ((v14.zzz*m63[2])+((v14.yyy*m63[1])+(v14.xxx*m63[0])));
	v1.w = v22.w;
	v0.xyzw = v22;
	var_TEXCOORD10.xyzw = v62;
	var_TEXCOORD11.xyzw = v68;
	var_TEXCOORD0.xy = in_ATTRIBUTE5;
	var_TEXCOORD7.xyzw = v61;
