...
{
	vec4 v0;
	v0.xyzw = texture(ps0,in_TEXCOORD0.xy);
	vec4 v1;
	v1.xyz = ((max(v0.xyz,vec3(0.000000e+00,0.000000e+00,0.000000e+00))*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v1.w = clamp(v0.w,0.000000e+00,1.000000e+00);
	out_Target0.xyzw = v1;
}
