...
void main()
{
	...
	v2.xyzw = v14;
	highp vec2 t15[1];
	t15[0].xy = vec2(0.000000e+00,0.000000e+00);
	t15[(1+(-1))].xy = in_ATTRIBUTE4;
	highp vec3 v16;
	v16.xyz = vec3(0.000000e+00,0.000000e+00,2.500000e-01);
	v2.xyz = (v14.xyz+v16);
	highp vec4 v17;
	v17.xyzw = (View_TranslatedWorldToClip[3]+((View_TranslatedWorldToClip[2]*v2.zzzz)+((View_TranslatedWorldToClip[1]*v2.yyyy)+(View_TranslatedWorldToClip[0]*v2.xxxx))));
	v1.xyzw = v2;
	highp vec3 v18;
	v18.xyz = (v2.xyz+(-View_TranslatedWorldCameraOrigin));
	float h19;
	vec3 v20;
	highp float f21;
	highp float f22;
	...
	float h25;
	float h26;
	h26 = MobileBasePass_Fog_ExponentialFogColorParameter.w;
	h25 = h26;
	highp float f27;
	f27 = dot(v18,v18);
	highp float f28;
	...
	vec3 v30;
	vec3 v31;
	v31.xyz = (v18*vec3(f28));
	v30.xyz = v31;
	f24 = MobileBasePass_Fog_ExponentialFogParameters.x;
	f23 = MobileBasePass_Fog_ExponentialFogParameters2.x;
	f22 = f29;
	f21 = v18.z;
	highp float f32;
	f32 = max(0.000000e+00,MobileBasePass_Fog_ExponentialFogParameters.w);
	if ((f32>0.000000e+00))
	{
		highp float f33;
		f33 = (f32*f28);
		...
		f34 = (f33*v18.z);
		highp float f35;
		f35 = (View_WorldCameraOrigin.z+f34);
		f22 = ((1.000000e+00+(-f33))*f29);
		f21 = (v18.z+(-f34));
		f24 = (MobileBasePass_Fog_ExponentialFogParameters3.x*exp2((-max(-1.270000e+02,(MobileBasePass_Fog_ExponentialFogParameters.y*(f35+(-MobileBasePass_Fog_ExponentialFogParameters3.y)))))));
		f23 = (MobileBasePass_Fog_ExponentialFogParameters2.z*exp2((-max(-1.270000e+02,(MobileBasePass_Fog_ExponentialFogParameters2.y*(f35+(-MobileBasePass_Fog_ExponentialFogParameters2.w)))))));
	}
	highp float f36;
	highp float f37;
	f37 = max(-1.270000e+02,(MobileBasePass_Fog_ExponentialFogParameters.y*f21));
	highp float f38;
	f38 = ((1.000000e+00+(-exp2((-f37))))/f37);
	highp float f39;
	f39 = (6.931472e-01+(-(2.402265e-01*f37)));
	highp float f40;
	f40 = abs(f37);
	highp float f41;
	f41 = ((f40>1.000000e-02))?(f38):(f39);
	f36 = (f24*f41);
	highp float f42;
	f42 = max(-1.270000e+02,(MobileBasePass_Fog_ExponentialFogParameters2.y*f21));
	highp float f43;
	...
	vec3 v49;
	vec3 v50;
	v50.xyz = MobileBasePass_Fog_ExponentialFogColorParameter.xyz;
	v49.xyz = v50;
	...
	if ((MobileBasePass_Fog_InscatteringLightDirection.w>=0.000000e+00))
	{
		...
		v51.xyz = v30;
		float h52;
		h52 = clamp(exp2((-(f47*max((f22+(-MobileBasePass_Fog_InscatteringLightDirection.w)),0.000000e+00)))),0.000000e+00,1.000000e+00);
		vec3 v53;
		v53.xyz = (MobileBasePass_Fog_DirectionalInscatteringColor.xyz*vec3(pow(clamp(dot(v51,MobileBasePass_Fog_InscatteringLightDirection.xyz),0.000000e+00,1.000000e+00),MobileBasePass_Fog_DirectionalInscatteringColor.w)));
		v20.xyz = (v53*vec3((1.000000e+00+(-h52))));
	}
	highp float f54;
	f54 = h25;
	float h55;
	h55 = max(clamp(exp2((-f48)),0.000000e+00,1.000000e+00),f54);
	h19 = h55;
	if (((MobileBasePass_Fog_ExponentialFogParameters3.w>0.000000e+00)&&(f29>MobileBasePass_Fog_ExponentialFogParameters3.w)))
	{
		h19 = 1.000000e+00;
		v20.xyz = vec3(0.000000e+00,0.000000e+00,0.000000e+00);
	}
	vec4 v56;
	v56.xyz = ((v49*vec3((1.000000e+00+(-h19))))+v20);
	v56.w = h19;
	highp vec4 t57[1];
	t57[0].xyzw = vec4(0.000000e+00,0.000000e+00,0.000000e+00,0.000000e+00);
	t57[(0/2)].xy = t15[0];
	highp vec4 v58;
	v58.w = 0.000000e+00;
	highp vec3 v59;
	...
	v1.w = v17.w;
	v0.xyzw = v17;
	var_TEXCOORD10.xyzw = v58;
	var_TEXCOORD11.xyzw = v60;
	var_TEXCOORD0.xyzw = t57[0];
	var_TEXCOORD7.xyzw = v56;
