...
void main()
{
	...
	float h1;
	float h2;
	h2 = (View_GameTime/5.000000e+00);
	h1 = fract(h2);
	highp vec2 v3;
	v3.xy = vec2(1.000000e+00,2.000000e+00);
	float h4;
	h4 = (View_GameTime/1.000000e+01);
	vec2 v5;
	v5.xy = (in_TEXCOORD0.xy*v3);
	highp vec2 v6;
	v6.xy = (v5+(vec2(0.000000e+00,5.000000e-01)*vec2(((round((h1+-2.500000e-01))*(1.000000e+00+(-((1.000000e+00+(-h1))*4.000000e+00))))+round(fract(h4))))));
	v0.xyz = ((max((pow(max(texture(ps0,v6).xyz,vec3(0.000000e+00,0.000000e+00,0.000000e+00)),vec3(1.250000e+00,1.250000e+00,1.250000e+00))*vec3(7.500000e-01,7.500000e-01,7.500000e-01)),vec3(0.000000e+00,0.000000e+00,0.000000e+00))*in_TEXCOORD7.www)+in_TEXCOORD7.xyz);
	v0.w = 0.000000e+00;
	float h7;
	h7 = min(in_TEXCOORD8.w,6.550000e+04);
	v0.w = h7;
	out_Target0.xyzw = v0;
}
